...
| Field | Type | Description |
|-------|------|-------------|
| `throughput` | `Optional[Dict]` | Throughput metrics |
| `annotator_performance` | `Optional[List[Dict]]` | Per-annotator performance data |
| `label_distribution` | `Optional[Dict]` | Distribution of annotations across labels |
| `status_breakdown` | `Optional[Dict[str, int]]` | Item count by status |
| `total` | `Optional[int]` | Total items |
