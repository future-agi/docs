...
<CardGroup cols={2}>
  <Card title="Create a Knowledge Base using UI" icon="window-maximize" href="/product/knowledge-base/how-to/create-kb-using-ui">
