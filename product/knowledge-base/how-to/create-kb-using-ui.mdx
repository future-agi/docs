...
<Steps>
  ...
  <Step title="Upload documents">
    ...
    <Note>
      For files above the UI limit (e.g. up to 100MB), use the [SDK](/product/knowledge-base/how-to/create-kb-using-sdk) to create or update the KB; the UI may show a message or sample code to guide you.
    </Note>
  </Step>
...
<CardGroup cols={2}>
  <Card title="Create a Knowledge Base using SDK" icon="code" href="/product/knowledge-base/how-to/create-kb-using-sdk">
    Automate creation and large file ingestion with the Python SDK.
  </Card>
  <Card title="Knowledge Base overview" icon="brain" href="/product/knowledge-base/overview">
