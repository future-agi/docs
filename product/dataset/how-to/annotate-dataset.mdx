...
<Steps>
  <Step title="Select a dataset">
    Go to **Datasets** from the dashboard and open the dataset you want to annotate. If you don't have a dataset yet, [create or upload one](/future-agi/get-started/dataset/adding-dataset/upload-file) first.
