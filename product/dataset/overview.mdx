...
<CardGroup cols={2}>
  ...
  <Card title="Evaluations" icon="chart-simple" href="/product/dataset/how-to/evaluate-dataset">
    Assess model performance using predefined or custom evaluation metrics
  </Card>
  <Card title="Optimizations" icon="wand-magic-sparkles" href="/product/dataset/how-to/optimizations-in-dataset">
    Optimize prompts and parameters using automated workflows
  </Card>
