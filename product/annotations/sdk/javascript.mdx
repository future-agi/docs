...
Log annotations using DataFrame-style records. Each record is an object with column keys following the same naming convention as the [Python SDK](/product/annotations/sdk/python).
...
<Tip>
For the full column naming convention table, see the [Python SDK -- Column naming convention](/product/annotations/sdk/python#column-naming-convention). The format is identical across both SDKs.
</Tip>
...
<CardGroup cols={3}>
  <Card title="Python SDK" icon="python" href="/product/annotations/sdk/python">
