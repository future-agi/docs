...
Use the table below to pick `eval_name` / `EvalName` and build your `mapping`. For full details on each eval, see the [Evaluation built-in evals](/product/evaluation/builtin-evals) docs.
