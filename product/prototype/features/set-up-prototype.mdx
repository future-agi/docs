...
<Steps>
  ...
  <Step title="Register your prototype project">
    ...
    | `eval_tags`            | `evalTags`           | (optional) Evals to run on prototype outputs. [Learn more](/product/prototype/features/evals) |
  ...
  <Step title="Optional next steps">
    ...
    - **Configure evals** — Define which evaluations run on your prototype outputs (EvalTag, mapping, model). [Configure evals for prototype](/product/prototype/features/evals)
    - **Compare and choose winner** — Rank versions by evals, cost, and latency, then promote the best. [Choose winner](/product/prototype/features/choose-winner)
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Choose winner" icon="trophy" href="/product/prototype/features/choose-winner">
