...
description: "Replay real production traces and sessions in a dev environment using chat simulation to debug, iterate, and improve your agent."
---
...
1. **Observe captures traces**  
   Your production system sends traces, messages, tools, and metadata to Future AGI via Observe.

2. **You select a session or trace**  
   Choose a full session or specific trace from the Observe UI.
...
| Component | Purpose |
|--------|---------|
| Observe | Capture real production traces |
...
Once Observe is integrated, **all traces and sessions automatically appear** in the Future AGI platform.
