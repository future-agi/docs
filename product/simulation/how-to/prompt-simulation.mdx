...
Before you start: have a **prompt template** with at least one saved **prompt version** and at least one **scenario** (see [Scenarios](/product/simulation/scenarios)).
...
<CardGroup cols={2}>
  ...
  <Card title="Fix My Agent" icon="wand-magic-sparkles" href="/product/simulation/how-to/fix-my-agent">
    Use AI-powered suggestions to improve your prompt based on simulation results.
  </Card>
  <Card title="Create Custom Evals" icon="chart-line" href="/future-agi/get-started/evaluation/create-custom-evals">
    Build evaluations tailored to your specific use case.
  </Card>
  <Card title="Agent-based Simulation" icon="robot" href="/product/simulation/agent-simulation">
