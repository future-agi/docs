...
Test guardrails before deploying to production. Use the gateway URL for testing.

<Note>
Replace `https://gateway.futureagi.com` with your actual gateway URL.
</Note>
...
<CardGroup cols={2}>
  <Card title="Routing" icon="arrow-right" href="/product/prism/how-to/routing">
    Route requests intelligently across models and providers
  </Card>
  <Card title="Providers" icon="plug" href="/product/prism/how-to/providers">
    Connect and manage LLM providers
  </Card>
  <Card title="Cost Tracking" icon="dollar-sign" href="/product/prism/how-to/cost-tracking">
