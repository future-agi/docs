...
3. **At least one provider configured** — If you have not added a provider yet, see [Manage Providers](/product/prism/how-to/providers). You will need your own API key for the provider you want to use (e.g., an OpenAI key).
...
<Tip>
To avoid provider failures affecting your users, configure [routing with failover](/product/prism/how-to/routing) so Prism automatically retries with a backup provider.
</Tip>
...
<CardGroup cols={2}>
  <Card title="Core Concepts" icon="book" href="/product/prism/concepts">
    Learn the fundamental concepts behind Prism
  </Card>
  <Card title="Manage Providers" icon="network-wired" href="/product/prism/how-to/providers">
  ...
  <Card title="Configure Routing" icon="arrows-split-up-and-left" href="/product/prism/how-to/routing">
