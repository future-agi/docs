    ...
    <Tabs sync={false}>
      <Tab title="Random Search" icon="shuffle">
        ...
        **Limitations:** No learning from previous attempts; may miss optimal solutions; quality depends on teacher model.
        ...
        [Random Search →](/product/optimization/optimizers/random-search)
      </Tab>
      <Tab title="Bayesian Search" icon="chart-line">
        ...
        **Limitations:** Requires examples in your dataset; may need many trials for complex spaces; best for structured tasks.
        ...
        [Bayesian Search →](/product/optimization/optimizers/bayesian-search)
      </Tab>
    </Tabs>
  </Tab>
    ...
    <Tabs sync={false}>
      <Tab title="Meta-Prompt" icon="brain">
        ...
        **Limitations:** Slower than search-based; higher API cost; may overfit to eval set.
        ...
        [Meta-Prompt →](/product/optimization/optimizers/meta-prompt)
      </Tab>
      <Tab title="ProTeGi" icon="microscope">
        ...
        **Limitations:** Can be expensive; needs clear failure signals; may need several rounds.
        ...
        [ProTeGi →](/product/optimization/optimizers/protegi)
      </Tab>
      ...
      <Tab title="PromptWizard" icon="wand-magic-sparkles">
        ...
        **Limitations:** Multiple stages can be slow; requires a good teacher model; may produce unconventional prompts.
        ...
        [PromptWizard →](/product/optimization/optimizers/promptwizard)
      </Tab>
    </Tabs>
  </Tab>
    ...
    <Tabs sync={false}>
      <Tab title="GEPA" icon="dna">
        ...
        **Limitations:** Requires the external `gepa` library; more complex setup; higher compute.
        ...
        [GEPA →](/product/optimization/optimizers/gepa)
      </Tab>
    </Tabs>
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  <Card title="Bayesian Search" icon="chart-line" href="/product/optimization/optimizers/bayesian-search">
    Few-shot optimization.
  </Card>
  <Card title="Using the Python SDK" icon="code" href="/product/optimization/how-to/using-python-sdk">
    Run optimizers in code.
  </Card>
  <Card title="Dataset optimization" icon="table" href="/product/optimization/how-to/dataset-optimization">
    Optimize prompts in dataset columns from the platform.
  </Card>
  <Card title="Optimization overview" icon="gauge" href="/product/optimization/overview">
