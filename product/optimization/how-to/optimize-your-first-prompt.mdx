...
- **Stepping stone to SDK** — Once this runs, you can move on to [Using the Python SDK](/product/optimization/how-to/using-python-sdk) for more options.
...
<CardGroup cols={2}>
  <Card title="Optimization fundamentals" icon="chart-line" href="/product/optimization/optimizers/overview">
