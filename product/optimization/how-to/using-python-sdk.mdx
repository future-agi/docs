...
<Steps>
  ...
  <Step title="Choose and initialize an optimizer">
    ...
    **Example: Meta-Prompt (deep reasoning)**
    ...
    For a detailed comparison, see the [Optimizers overview](/product/optimization/optimizers/overview).
  </Step>
...
<CardGroup cols={2}>
  <Card title="Optimize your first prompt" icon="wand-magic-sparkles" href="/product/optimization/how-to/optimize-your-first-prompt">
    Minimal end-to-end example with Random Search.
  </Card>
  <Card title="Optimizers overview" icon="chart-line" href="/product/optimization/optimizers/overview">
    Compare algorithms and choose the right one.
  </Card>
  <Card title="Using the platform" icon="window-maximize" href="/product/optimization/how-to/using-platform">
