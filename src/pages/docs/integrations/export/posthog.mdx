...
This is useful when your product team wants to understand LLM usage patterns alongside other product events in PostHog - which features trigger the most LLM calls, how costs break down by user segment, or where latency spikes correlate with drop-offs.
