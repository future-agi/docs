---
title: "Export to PostHog: LLM Usage Events for Product Analytics"
description: "Send LLM usage events from Future AGI's Agent Command Center to PostHog for product analytics, user behavior tracking, and event-based insights."
---
