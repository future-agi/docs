...
This integration archives your Prism Gateway traffic to cloud object storage for long-term retention, compliance, or offline analysis. Logs are written as gzip-compressed JSONL files, partitioned by date:
