---
title: "PagerDuty Alerts: Route Future AGI Alerts to On-Call Teams"
description: "Route Future AGI alerts to PagerDuty so your on-call team receives notifications when something breaks in your AI agent pipeline."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Set up alerts in Future AGI" href="/docs/observe/guides/setup-alerts" />
