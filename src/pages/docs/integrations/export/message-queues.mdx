...
Useful when you want to build custom processing on top of your LLM traffic - for example, feeding requests into your own analytics pipeline, triggering custom alerts, or replicating data to a warehouse on your own terms.
...
You also need **Admin** or **Owner** role in your Future AGI workspace.
...
<CardGroup cols={2}>
  ...
  <Card title="Prism Gateway overview" href="/docs/prism/overview" />
</CardGroup>
