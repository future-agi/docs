---
title: "Import from Langfuse: Pull Traces and Scores into Future AGI"
description: "Pull existing Langfuse traces, spans, and scores into Future AGI automatically to continue evaluation and analysis without re-instrumentation."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Set up alerts" href="/docs/observe/guides/setup-alerts" />
