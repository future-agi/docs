---
title: "n8n Integration with Future AGI for Prompt Management"
description: "Dynamically retrieve prompts from your Future AGI account in n8n, select specific versions, and compile prompts with variables in the n8n interface."
---
