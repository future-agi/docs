---
title: "LiveKit Integration with Future AGI for Voice Agent Tracing"
description: "Integrate LiveKit with Future AGI observability using traceai-livekit. Trace voice agent sessions, audio pipelines, and tool calls automatically."
---
