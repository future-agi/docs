---
title: "OpenAI Java Integration with Future AGI Tracing"
description: "Trace OpenAI chat completions, embeddings, and streaming responses in Java with TracedOpenAIClient for automatic LLM observability in Future AGI."
---
