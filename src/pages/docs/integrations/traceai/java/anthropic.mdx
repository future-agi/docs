---
title: "Anthropic Java Integration with Future AGI Tracing"
description: "Trace Anthropic Messages API calls in Java with TracedAnthropicClient. Uses reflection for cross-version compatibility and automatic span capture."
---
