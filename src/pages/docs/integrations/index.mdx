...
<CardGroup cols={2}>
  ...
  <Card title="Langfuse" href="/docs/tracing/manual/langfuse-intergation" />
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Experiment" href="/docs/integrations/traceai/experiment" />
</CardGroup>
...
|---|---|---|
| Langfuse | Live | You're migrating from Langfuse or running both platforms side by side |
| LangSmith | Coming Soon | You use LangSmith and want Future AGI's evaluation and dataset features |
| Arize | Coming Soon | You have existing Arize traces to evaluate |
