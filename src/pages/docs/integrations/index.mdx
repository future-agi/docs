---
title: "Future AGI Integrations: Frameworks, LLMs, and Tools"
description: "Connect Future AGI with your existing AI frameworks, LLM providers, observability tools, and data export destinations for full-stack AI monitoring."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Langfuse (SDK tracing)" href="/docs/sdk/tracing/langfuse-integration" />
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="VAPI" href="/docs/observe/concepts/voice-observability" />
  <Card title="Retell" href="/docs/observe/concepts/voice-observability" />
</CardGroup>
