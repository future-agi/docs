...
<CardGroup cols={2}>
  ...
  <Card title="Langfuse (SDK tracing)" href="/docs/tracing/manual/langfuse-intergation" />
</CardGroup>
...
Route Future AGI data to the tools your team already monitors. Exports forward data from the [Prism Gateway](/docs/prism) and are configured through **Settings > Integrations** with no code changes.
