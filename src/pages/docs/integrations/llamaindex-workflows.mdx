...
Our [LlamaIndexInstrumentor](/docs/products/observability/auto-instrumentation/llamaindex) automatically captures traces for LlamaIndex Workflows agents. If you've already enabled that instrumentor, you do not need to complete the steps below.
