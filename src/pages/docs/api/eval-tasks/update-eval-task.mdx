...
description: "Updates an eval task's configuration and optionally reruns it."
---
...
<ApiSection title="Request body">
  ...
  <ParamField body="sampling_rate" type="number" optional>
    Updated percentage of spans to evaluate (`1.0`-`100.0`).
  </ParamField>
...
<ApiSection title="Errors">
  <ParamField name="400" type="Bad Request">
    Invalid values, task is `running` or `deleted`, or missing required fields.
  </ParamField>
