...
description: "Returns a paginated list of eval tasks."
---
...
<ApiSection title="Response" status={200} statusText="OK">
  <ResponseField name="metadata" type="object">Pagination metadata with `total_rows`.</ResponseField>
  <ResponseField name="table" type="array">Array of eval task objects.</ResponseField>
