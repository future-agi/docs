...
description: "Returns a paginated list of agent definitions."
---
...
<ApiSection title="Query parameters">
  <ParamField query="search" type="string" optional>
    Case-insensitive search across name, contact number, description, and assistant ID.
  </ParamField>
  ...
  <ParamField query="agent_definition_id" type="string" optional>
    Pins the specified agent as the first result on page 1.
  </ParamField>
</ApiSection>

<ApiSection title="Response" status={200} statusText="OK">
  <ResponseField name="count" type="integer">Total matching agent definitions.</ResponseField>
  ...
  <ResponseField name="results" type="array">Array of agent definition objects.</ResponseField>
