...
<ParamField body="model_type" type="string">
  The model type for the dataset. Defaults to `GenerativeLLM`. One of: `Numeric`, `ScoreCategorical`, `Ranking`, `BinaryClassification`, `Regression`, `ObjectDetection`, `Segmentation`, `GenerativeLLM`, `GenerativeImage`, `GenerativeVideo`, `TTS`, `STT`, `MultiModal`.
</ParamField>

<ParamField body="source" type="string">
  Source of the dataset. Defaults to `build`. One of: `build`, `sdk`, `demo`, `observe`.
</ParamField>
...
formData.append("model_type", "GenerativeLLM");
