...
<ApiSection title="Response" status={200} statusText="OK">
  ...
  <ApiCollapsible title="Show 30 persona properties">
    ...
    <ResponseField name="personaType" type="string">
      The origin type of the persona: `system` or `workspace`.
    </ResponseField>
    ...
    <ResponseField name="gender" type="array of string">
      Gender attributes. Possible values: `male`, `female`.
    </ResponseField>
    <ResponseField name="ageGroup" type="array of string">
      Age group ranges. Possible values: `18-25`, `25-32`, `32-40`, `40-50`, `50-60`, `60+`.
    </ResponseField>
    <ResponseField name="occupation" type="array of string">
      Occupation descriptors. Sent as `profession` in create/update requests.
    </ResponseField>
    ...
    <ResponseField name="languages" type="array of string">
      Languages the persona can communicate in. Sent as `language` in create requests.
    </ResponseField>
    ...
    <ResponseField name="metadata" type="object or null">
      Additional key-value metadata. Sent as `customProperties` in create/update requests.
    </ResponseField>
