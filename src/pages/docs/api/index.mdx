...
<CardGroup cols={2}>
  ...
  <Card title="Agent Definitions" href="/docs/api/agent-definitions/createagentdefinition" icon="code">
  ...
  <Card title="Eval Tasks" href="/docs/api/eval-tasks/list-eval-tasks" icon="code">
    Eval task lifecycle — create, pause, resume, and manage evaluation runs on trace spans
  </Card>
  <Card title="Custom Eval Configs" href="/docs/api/custom-eval-configs/list-custom-eval-configs" icon="code">
