...
<CardGroup cols={2}>
  <Card title="Health" href="/docs/api/health" icon="code">
  ...
  <Card title="Scenarios" href="/docs/api/scenarios" icon="code">
    Test scenario management and execution
  </Card>
  <Card title="Agent Definitions" href="/docs/api/agent-definitions" icon="code">
    Agent definition CRUD operations
  </Card>
  <Card title="Agent Versions" href="/docs/api/agent-versions" icon="code">
  ...
  <Card title="Run Tests" href="/docs/api/run-tests" icon="code">
  ...
  <Card title="Eval Groups" href="/docs/api/eval-groups" icon="code">
  ...
  <Card title="Eval Logs & Metrics" href="/docs/api/eval-logs-metrics" icon="code">
