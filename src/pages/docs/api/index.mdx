---
title: "API Reference — Future AGI"
description: "Complete REST API reference for the Future AGI platform. Covers simulations, evaluations, scenarios, personas, datasets, annotations, and more."
---
