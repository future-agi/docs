...
<ApiPlayground
  ...
  responseExample={{
    ...
    version: { id: "f7a8b9c0-d1e2-3456-789a-bcdef0123456", version_number: 2, version_name: "v2", version_name_display: "v2", status: "active", status_display: "Active", score: null, test_count: 0, pass_rate: null, description: "Improved prompt for better handling of refund requests", commit_message: "Updated refund handling logic", release_notes: null, agent_definition: "a1b2c3d4-e5f6-7890-abcd-ef1234567890", organization: "org-uuid", configuration_snapshot: { agent_name: "support-bot-v2", provider: "vapi", language: "en" }, is_active: true, is_latest: true, created_at: "2026-04-13T10:30:00Z", updated_at: "2026-04-13T10:30:00Z" }
  }}
  responseStatus={201}
...
<ApiSection title="Request body">
  ...
  <ParamField body="agent_type" type="string" optional>
...
<ApiSection title="Errors">
  <ParamField name="400" type="Bad Request">
    The request body failed validation. Common causes include invalid field values or missing the required `commit_message`.
