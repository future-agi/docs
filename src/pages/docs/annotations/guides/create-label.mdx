...
Labels aren't tied to a project, they live in the workspace you create them in. Go to **Annotations** in the sidebar and switch to the **Labels** tab. Click **Create Label** to open the form.
