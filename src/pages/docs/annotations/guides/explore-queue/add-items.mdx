...
<Note>
Filter mode caps a selection at 10,000 items. The picker splits your add into batches that stay under the 1,000-item-per-call cap; call the endpoint yourself and an enumerated list over 1,000 items is rejected outright with an HTTP 413. Full caps and gated behavior live on [Queue settings & limits](/docs/annotations/reference/queue-settings-and-limits).
</Note>
...
<Note>
An item's preview is a snapshot taken the moment it's added, not a live read of the source.
</Note>
