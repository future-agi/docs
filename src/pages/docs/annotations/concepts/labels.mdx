...
- **Categorical** collects one option chosen from a list you define, best for a defect category, a sentiment, or an escalation reason
...
| If you need | Pick |
| --- | --- |
| The answer to always be one of a few known outcomes | Categorical |
