...
<Steps>
  ...
  <Step title="Add annotators">
    Select workspace members who will annotate items. Anyone with access to the workspace can already browse the queue; only the people you add here can annotate in it.
  </Step>
  ...
  <Step title="Save the queue">
    Click **Create annotation queue**. The queue is created in **Draft** status. Add items and review settings before activating it.
  </Step>
</Steps>
