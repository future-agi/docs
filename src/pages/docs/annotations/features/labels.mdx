...
- **Duplicate** -- Use the `⋮` menu and select **Duplicate**. This creates a copy named "Copy of {original name}" that you can customize.
...
| Text | `placeholder`, `min_length`, `max_length` | `""`, 0, 5000 |
| Star | `no_of_stars` | 5 |
| Thumbs Up/Down | -- | -- |
...
<CardGroup cols={3}>
  ...
  <Card title="Labels Concept" icon="tags" href="/docs/annotations/concepts/labels">
