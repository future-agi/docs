...
**Creating a prompt from scratch** means building a new prompt manually in the Prompt Workbench: you name it, choose a model, set parameters (temperature, max tokens, etc.), optionally add tools, then write the system and user content and run it. No template or AI generation is used—you have full control over structure and wording. Use this when you want to design a prompt exactly to your needs without starting from an existing template or generated draft.

---

## Use cases

- **Full control** — Define every part of the prompt (system, user, variables) and model settings yourself.
- **Learning the editor** — Get familiar with the Workbench by building a simple prompt step by step.
- **One-off or experimental prompts** — Quickly try an idea without cloning or customizing a template.
- **Custom tools and parameters** — Attach tools and tune temperature, max tokens, and other model parameters from the start.
...
<Steps>
  <Step title="Navigate to the Prompts Section">
    ...
    ![Navigate to Prompts section](/images/docs/prompt-create/1.png)
  </Step>
  ...
  <Step title="Create a New Prompt">
    ...
    ![Click Create prompt](/images/docs/prompt-create/2.png)
    ...
    ![Select Start from scratch](/images/docs/prompt-create/3.png)
  </Step>
  ...
  <Step title="Configure your prompt">
    ...
    ![Rename your prompt](/images/docs/prompt-create/4.png)
    ...
    ![Choose a model](/images/docs/prompt-create/5.png)
    ...
    ![Configure model parameters](/images/docs/prompt-create/6.png)
    ...
    ![Configure a tool](/images/docs/prompt-create/7.png)
  </Step>
  ...
  <Step title="Write and run your prompt">
    ...
    ![Run your prompt](/images/docs/prompt-create/8.png)
  </Step>
