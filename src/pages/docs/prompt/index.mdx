...
<CardGroup cols={2}>
  <Card 
    ...
    icon="pen-to-square" 
    href="/docs/prompt/how-to/create-prompt-from-scratch"
  >
  ...
  <Card 
    ...
    icon="clone" 
    href="/docs/prompt/how-to/create-prompt-from-existing-template"
  >
  ...
  <Card 
    ...
    icon="link" 
    href="/docs/prompt/how-to/linked-traces"
  >
  ...
  <Card 
    ...
    icon="folder" 
    href="/docs/prompt/how-to/manage-folders"
  >
