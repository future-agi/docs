...
<Steps>
  <Step title="Open the Prototype dashboard">
    ...
    ![Open the Prototype dashboard](/screenshot/docs/prototype/1.png)
  </Step>

  <Step title="Start Choose Winner">
    Click the **Choose Winner** button to open the comparison and ranking flow.
    ![Open the Choose Winner flow](/screenshot/docs/prototype/2.png)
  </Step>
  ...
  <Step title="Set metric importance">
    ...
    ![Set metric importance](/screenshot/docs/prototype/3.png)
  </Step>
...
<CardGroup cols={2}>
  <Card title="Set up prototype" icon="wrench" href="/docs/prototype/set-up-prototype">
