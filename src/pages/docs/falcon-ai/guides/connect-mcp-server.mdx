...
<img src="/images/docs/falcon-ai/guides/connect-mcp-server-discovered.png" alt="A connected connector's detail pane with the Edit, Discover Tools, Test Connection, and Delete buttons above a Discovered Tools list holding one tool, its description, and an enabled toggle" style={{ borderRadius: '5px' }} />
