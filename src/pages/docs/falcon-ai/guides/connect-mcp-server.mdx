...
Discovering a server's tools only catalogs what it offers; it doesn't hand Falcon AI permission to call any of them. The next step is turning specific tools on, covered in [Choose connector tools](/docs/falcon-ai/guides/choose-connector-tools).
