...
The chat input's **+** menu has a **Connectors** submenu listing every connector configured for the workspace along with its connected state, and a **Manage connectors** link out to Customize. If none are configured yet, it reads "No connectors configured" instead.
