...
<Tip>
Already mid-conversation? The Skills menu in the chat header also has a **Create Skill** entry, which opens a separate dialog for building a skill without leaving the chat. That dialog also has an Icon field, and its Save button stays disabled until Name, Instructions, and at least one trigger phrase are filled in.
</Tip>
