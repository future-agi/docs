...
<CardGroup>
  ...
  <Card title="Agent Compass" icon="compass" href="/docs/agent-compass">
  ...
  <Card title="Tracing" icon="magnifying-glass" href="/docs/tracing">
    Monitor cost, latency, and evaluation results through comprehensive tracing capabilities.
  </Card>

  <Card title="MCP Server" icon="plug" href="/docs/quickstart/mcp-server">
...
<Tip>
Start using Future Platform today at [app.futureagi.com](https://app.futureagi.com)
</Tip>
