...
Self-hosting runs the full Future AGI platform on infrastructure you control. The backend runs on Django, the frontend on React + Vite. All data and secrets stay on your machines. First boot takes 10 to 15 minutes (images build from source). After that, starts take under 30 seconds.
