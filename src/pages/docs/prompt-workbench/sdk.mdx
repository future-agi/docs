...
description: "Create and manage prompt templates using the Future AGI SDK. Define versioned prompts with variables, labels, and model configuration parameters."
---
...
To link prompts to traces, you need to associate the prompt used in a generation with the corresponding trace. This process has been highlighted [here](/docs/tracing/manual/log-prompt-templates).
