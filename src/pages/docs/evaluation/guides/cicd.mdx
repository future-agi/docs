...
<Steps>
  <Step title="Add the requirements file">
  ...
  <Step title="Write the evaluation script">
  ...
  <Step title="Set the required secrets and variables">
  ...
  <Step title="Open a pull request and read the results">
    ...
    <img src="/images/eval_ci_cd.png" alt="A GitHub pull request comment posted by the workflow, showing the current version and a metrics comparison table across versions." style={{ borderRadius: '5px' }} />
