...
<img src="/images/docs/evaluation/explore-playground/test-an-eval/select-eval.png" alt="The Evaluations list searched for hallucination, showing conversation_hallucination, caption_hallucination, and detect_hallucination, with a prompt to select the eval to test" style={{ borderRadius: '5px' }} />
