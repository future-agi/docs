...
- **[completeness](/docs/get-started/evaluation/builtin-evals/completeness): Determines if the response addresses all aspects of the query
- **[task-completion](/docs/get-started/evaluation/builtin-evals/task-completion): Checks if a specific requested task was accomplished
- **[instruction-adherence](/docs/get-started/evaluation/builtin-evals/instruction-adherence): Evaluates if the response follows specific instructions
- **[is-concise](/docs/get-started/evaluation/builtin-evals/is-concise): Assesses whether the response avoids unnecessary verbosity 