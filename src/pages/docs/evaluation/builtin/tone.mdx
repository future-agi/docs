...
- [**Toxicity**](/docs/products/evaluation/eval-definition/toxicity): While Tone Analysis evaluates the emotional context and sentiment of the text, Toxicity evaluation focuses on identifying language that is harmful or offensive.
- [**Sexist**](/docs/products/evaluation/eval-definition/sexist): Tone Analysis is about understanding emotional context, whereas Sexist Content Detection specifically targets language that perpetuates gender stereotypes or discrimination.