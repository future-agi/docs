---
title: "Is Email: Email Address Format Validation Metric"
description: "Evaluates whether input text is a valid email address, checking for standard formatting including an @ symbol, domain name, and valid top-level domain."
---
...
### Differentiating "Is Email" from generic text checks
