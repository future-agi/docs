---
title: "Ground Truth Match: Expected Output Evaluation Metric"
description: "Evaluates whether model-generated output matches the ground-truth expected output, checking semantic equivalence rather than exact string matching."
---
