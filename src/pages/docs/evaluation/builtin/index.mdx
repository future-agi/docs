...
Each row lists the inputs a template needs, where it fits, and how it scores, whether by an LLM judge, a deterministic rule, or a statistical metric. For what the resulting scores mean, see [Output types & scoring](/docs/evaluation/reference/output-types).
