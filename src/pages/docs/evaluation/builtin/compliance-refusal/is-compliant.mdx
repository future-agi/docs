...
- [**Content Safety Violation**](https://docs.futureagi.com/docs/evaluation/builtin/content-safety-violation): Is Compliant provides a broader assessment of guideline adherence, while Content Safety Violation focuses specifically on detecting harmful, unsafe content.
- [**Is Harmful Advice**](https://docs.futureagi.com/docs/evaluation/builtin/is-harmful-advice): Is Compliant evaluates overall policy adherence, whereas Is Harmful Advice specifically identifies potentially dangerous recommendations.
- [**Toxicity**](https://docs.futureagi.com/docs/evaluation/builtin/toxicity): Is Compliant evaluates general policy compliance, while Toxicity specifically measures harmful or offensive language. 