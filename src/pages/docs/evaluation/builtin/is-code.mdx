---
title: "Contains Code: Code Presence Validation Metric"
description: "Checks whether output is valid code or contains expected code snippets, validating code structure and syntax for LLM-generated programming output."
---
