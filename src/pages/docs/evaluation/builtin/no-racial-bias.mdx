---
title: "No Racial Bias: Race Discrimination Detection Metric"
description: "Detects racial bias, stereotypes, and discriminatory language in AI output. Returns Passed if no racial bias is found, Failed if detected."
---
