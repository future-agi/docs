---
title: "MRR: Mean Reciprocal Rank for RAG Retrieval Evaluation"
description: "Measures how early the first relevant result appears in ranked retrieval. A RAG metric that scores using the reciprocal rank of the first correct answer."
---
