---
title: "NDCG@K: Ranking Quality Evaluation Metric for RAG"
description: "Rates RAG retrieval ranking quality, rewarding relevant results that appear earlier in the top-K list using Normalized Discounted Cumulative Gain."
---
