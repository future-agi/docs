...
> Click [here](https://docs.futureagi.com/docs/evaluation/running-your-first-eval#using-python-sdk-sync) to learn how to setup evaluation using the Python SDK.
> 
