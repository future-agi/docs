---
title: "Precision@K: Retrieval Accuracy Evaluation Metric for RAG"
description: "Measures the fraction of top-K retrieved chunks that are actually relevant. A RAG retrieval metric that quantifies how much noise your retriever returns."
---
