---
title: "Customer Agent Query Handling Evaluation Metric"
description: "Assesses how effectively the agent interprets user queries and provides relevant, helpful answers, measuring query understanding and response quality."
---
