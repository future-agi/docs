---
title: "Hit Rate: RAG Retrieval Coverage Evaluation Metric"
description: "Checks whether at least one relevant chunk was retrieved in a RAG pipeline, measuring basic retrieval coverage as a simple high-level metric."
---
