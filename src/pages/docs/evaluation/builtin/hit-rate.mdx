...
- [**Recall@K**](/docs/evaluation/builtin/rag-retrieval/recall-at-k): Hit Rate only checks if any relevant chunk was found, while Recall@K measures the fraction of all relevant chunks that were retrieved.
- [**MRR**](/docs/evaluation/builtin/rag-retrieval/mrr): Hit Rate is binary (hit or miss), while MRR additionally measures how high the first relevant chunk ranks.
- [**Precision@K**](/docs/evaluation/builtin/rag-retrieval/precision-at-k): Hit Rate checks for the existence of any relevant result, while Precision@K measures what fraction of all retrieved results are relevant.
