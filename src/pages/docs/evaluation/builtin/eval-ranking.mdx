...
title: "Eval Ranking: Context Relevance Scoring Metric"
description: "Assigns a ranking score to each context based on specified criteria, ensuring contexts are ordered by relevance and suitability for the given input."
---
