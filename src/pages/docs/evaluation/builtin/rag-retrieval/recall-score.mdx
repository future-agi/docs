...
<Warning>
`recall_score` is being deprecated. Avoid using it for new integrations.
Use `recall_at_k` for new implementations.
</Warning>
...
- [**ROUGE Score**](/docs/evaluation/builtin/rouge): While Recall Score focuses on information coverage, ROUGE Score uses n-gram overlap to evaluate text similarity.
- [**BLEU Score**](/docs/evaluation/builtin/bleu): Recall Score measures how much reference information is captured, while BLEU Score emphasizes precision by measuring how much of the hypothesis matches the reference.
- [**Completeness**](/docs/evaluation/builtin/completeness): Recall Score measures information coverage from a reference text, whereas Completeness evaluates whether a response fully answers a given query. 