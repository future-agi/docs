...
- [**Summary Quality**](/docs/get-started/evaluation/builtin-evals/summary-quality): While Is Good Summary provides a binary assessment (Passed/Failed), Summary Quality might offer more granular ratings of summary effectiveness.
- [**Completeness**](/docs/get-started/evaluation/builtin-evals/completeness): Is Good Summary focuses on the overall effectiveness of a summary, whereas Completeness specifically measures whether all required information is included.
