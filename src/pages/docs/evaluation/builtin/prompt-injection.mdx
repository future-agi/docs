---
title: "Prompt Injection Attack Detection Evaluation Metric"
description: "Detects attempts to manipulate LLM behavior through crafted inputs, identifying prompt injection attacks and security vulnerabilities in AI systems."
---
