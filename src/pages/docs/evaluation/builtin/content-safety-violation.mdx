...
- [**Is Compliant**](/docs/get-started/evaluation/builtin-evals/is-compliant): Content Safety Violation focuses specifically on harmful or unsafe content, while Is Compliant provides a broader assessment of adherence to guidelines and policies.
- [**Toxicity**](/docs/get-started/evaluation/builtin-evals/toxicity): Content Safety Violation covers a broad range of safety issues, whereas Toxicity specifically measures offensive or harmful language.
- [**Is Harmful Advice**](/docs/get-started/evaluation/builtin-evals/is-harmful-advice): Content Safety Violation detects various types of unsafe content, while Is Harmful Advice focuses specifically on dangerous recommendations or guidance. 