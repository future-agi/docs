...
- [**Instruction Adherence**](/docs/evaluation/builtin/prompt-adherence): Detect Hallucination checks for fabricated information not present in the source, while Instruction Adherence evaluates whether the output follows the instructions provided.
