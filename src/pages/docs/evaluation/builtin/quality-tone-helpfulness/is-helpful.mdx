...
- **[completeness](/docs/evaluation/builtin/completeness): Determines if the response addresses all aspects of the query
- **[task-completion](/docs/evaluation/builtin/task-completion): Checks if a specific requested task was accomplished
- **[instruction-adherence](/docs/evaluation/builtin/instruction-adherence): Evaluates if the response follows specific instructions
- **[is-concise](/docs/evaluation/builtin/is-concise): Assesses whether the response avoids unnecessary verbosity 