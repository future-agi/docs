---
title: "LLM Function Calling Accuracy Evaluation Metric"
description: "Evaluates whether LLM output correctly identifies when to call a function, selects the right tool, and extracts the appropriate parameters from the input."
---
...
- [**Instruction Adherence**](/docs/evaluation/builtin/prompt-adherence): Evaluate Function Calling focuses on whether the correct function and parameters were identified, while Instruction Adherence evaluates whether the output follows the prompt instructions more broadly.