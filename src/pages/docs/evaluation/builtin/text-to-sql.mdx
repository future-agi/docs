---
title: "Text to SQL: Natural Language to Query Accuracy Metric"
description: "Evaluates the accuracy and quality of SQL queries generated from natural language instructions, checking query correctness and structural integrity."
---
