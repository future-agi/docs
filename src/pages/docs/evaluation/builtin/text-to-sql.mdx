...
- [**Task Completion**](/docs/get-started/evaluation/builtin-evals/task-completion): While Text to SQL focuses specifically on converting natural language to SQL queries, Task Completion evaluates whether a response completes the requested task more generally.
- [**Evaluate Function Calling**](/docs/get-started/evaluation/builtin-evals/llm-function-calling): Text to SQL evaluates SQL generation specifically, whereas Evaluate Function Calling assesses the correctness of function calls and parameters more broadly.
- [**Is Code**](/docs/get-started/evaluation/builtin-evals/is-code): Text to SQL evaluates the correctness of SQL generation, while Is Code detects whether content contains code of any type. 