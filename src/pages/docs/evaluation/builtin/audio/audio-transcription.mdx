...
- [**Audio Quality**](https://docs.futureagi.com/docs/evaluation/builtin/audio-quality): While Audio Transcription evaluates the accuracy of converting speech to text, Audio Quality assesses the perceptual quality of the audio itself.
- [**Context Adherence**](https://docs.futureagi.com/docs/evaluation/builtin/context-adherence): Audio Transcription focuses on accurately capturing spoken words, while Context Adherence evaluates how well content aligns with given context or instructions.