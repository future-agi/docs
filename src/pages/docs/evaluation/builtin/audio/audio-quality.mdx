...
- [**Audio Transcription**](https://docs.futureagi.com/docs/evaluation/builtin/audio-transcription): While Audio Quality evaluates the perceptual quality of the audio itself, Audio Transcription assesses the accuracy of converting speech in the audio to text.
