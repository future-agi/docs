...
title: "Context Relevance: RAG Retrieval Quality Metric"
description: "Evaluates whether provided context is sufficient and relevant to answer a query, ensuring RAG retrieval surfaces chunks that support accurate responses."
---
