...
- [Contains Valid Link](/docs/get-started/evaluation/builtin-evals/valid-links#1-contains-valid-link)
- [No Valid Links](/docs/get-started/evaluation/builtin-evals/valid-links#2-no-valid-links)
...
> Click [here](/docs/get-started/evaluation/running-your-first-eval#using-python-sdk-sync) to learn how to setup evaluation using SDK.
> 
