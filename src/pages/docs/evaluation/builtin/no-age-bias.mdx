---
title: "No Age Bias: Age Discrimination Detection Metric"
description: "Detects age-related bias, stereotypes, and discriminatory language in AI output. Returns Passed if no age bias is found, Failed if detected."
---
