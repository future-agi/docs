...
- [**Factual Accuracy**](/docs/evaluation/builtin/factual-accuracy): While Is Factually Consistent focuses on consistency with the provided input or context, Factual Accuracy might verify claims against broader world knowledge.
- [**Groundedness**](/docs/evaluation/builtin/groundedness): Is Factually Consistent evaluates whether output contradicts the source, while Groundedness measures how well the output is supported by the source.
