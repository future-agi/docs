...
title: "Conversation Resolution: Query Completion Metric"
description: "Evaluates whether each user query receives a complete response, checking that questions are answered and conversations reach satisfactory conclusions."
---
