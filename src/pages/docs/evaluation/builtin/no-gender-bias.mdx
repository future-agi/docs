---
title: "No Gender Bias: Gender Discrimination Detection Metric"
description: "Detects gender-related bias, stereotypes, and discriminatory language in AI output. Returns Passed if no gender bias is found, Failed if detected."
---
