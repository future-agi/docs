...
- For each n-gram, modified n-gram precision is calculated: **P_1, P_2, ..., P_N**
...
- The geometric mean of these scores in log form is: `BLEU = exp( sum(w_n * log P_n) )`
...
- So the final BLEU score is: `BLEU = BP * exp( sum(w_n * log P_n) )`
