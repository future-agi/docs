...
- [**Content Safety Violation**](/docs/get-started/evaluation/builtin-evals/content-safety-violation): Is Compliant provides a broader assessment of guideline adherence, while Content Safety Violation focuses specifically on detecting harmful, unsafe content.
- [**Is Harmful Advice**](/docs/get-started/evaluation/builtin-evals/is-harmful-advice): Is Compliant evaluates overall policy adherence, whereas Is Harmful Advice specifically identifies potentially dangerous recommendations.
- [**Toxicity**](/docs/get-started/evaluation/builtin-evals/toxicity): Is Compliant evaluates general policy compliance, while Toxicity specifically measures harmful or offensive language. 