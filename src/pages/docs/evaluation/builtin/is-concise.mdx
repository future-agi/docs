...
- [completeness](/docs/get-started/evaluation/builtin-evals/completeness): Ensures that despite being concise, the response addresses all aspects of a query
- [is-helpful](/docs/get-started/evaluation/builtin-evals/is-helpful): Evaluates if the response is actually useful despite its brevity
- [instruction-adherence](/docs/get-started/evaluation/builtin-evals/instruction-adherence): Checks if the response follows instructions, which might include requirements for detail
- [length-evals](/docs/get-started/evaluation/builtin-evals/length-evals): Provides quantitative metrics about text length 