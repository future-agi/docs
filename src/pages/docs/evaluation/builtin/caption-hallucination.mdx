...
- [**Factual Accuracy**](/docs/evaluation/builtin/factual-accuracy): Caption Hallucination focuses on whether descriptions match what's visible in images, while Factual Accuracy evaluates correctness of factual statements more generally. 