  ...
  <Tab title="Using UI" icon="display">
    <Steps>
      ...
      <Step title="Configure basic settings">
        ...
        **Model** — **Use Future AGI Models** (e.g. turing_large, turing_flash, turing_small, protect, protect_flash) or **Use other LLMs** (your own or external providers). For model details, see [Future AGI models](/docs/evaluation/future-agi-models) and [Use custom models](/docs/evaluation/use-custom-models).
  ...
  <Tab title="Using SDK" icon="code">
    ...
    <Steps>
      <Step title="Authenticate">
        Use your Future AGI API credentials (e.g. `fi_api_key` and `fi_secret_key`, or your project's auth header). See [Accessing API keys](/docs/admin-settings#accessing-api-keys) for how to obtain them.
      </Step>
