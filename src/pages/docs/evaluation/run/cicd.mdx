...
description: "Run FutureAGI evaluations in your CI/CD pipeline to assess model performance on every pull request and keep quality checks consistent before deployment."
---
...
- A FutureAGI account with API key and secret key
...
|---|---|---|
| `PROJECT_NAME` | FutureAGI project name | `Voice Agent` |
...
<CardGroup cols={2}>
  <Card title="Evaluate via Platform & SDK" icon="play" href="/docs/evaluation/run/in-the-ui">
  ...
  <Card title="Use custom models" icon="database" href="/docs/evaluation/judge-models/custom">
