...
You can also bring your own model using the [custom models](/docs/evaluation/guides/custom-models) integration. This is useful when you need a domain-specific fine-tuned model, want to keep inference in a specific cloud region, or already pay for a model you want to use as the judge.
...
| Domain-specific or compliance requirements | [Custom model](/docs/evaluation/guides/custom-models) |

---

## Next steps

- [Use custom models](/docs/evaluation/guides/custom-models): Bring your own model as the judge.
