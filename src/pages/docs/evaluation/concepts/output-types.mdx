---
title: "Output types"
description: "What an eval returns: pass/fail, scores, or choices, and where results land"
---
...
- [Evaluate via Platform & SDK](/docs/evaluation/guides/running-evaluations): Run an eval and see results.
...
- [CI/CD pipeline](/docs/evaluation/guides/cicd): Track results by version across deploys.
