...
**Requires a judge model.** Configure one in [Future AGI models](/docs/evaluation/concepts/judge-models) or [custom models](/docs/evaluation/features/custom-models).
