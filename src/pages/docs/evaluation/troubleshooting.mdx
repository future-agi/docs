...
| Can't find your API keys | Only Owners, Admins, and Workspace Admins can open the Keys page | Open **Build → Keys** in the left sidebar, or ask an Owner or Admin; see [API Keys](/docs/admin-settings/api-keys) |
...
`FI_API_KEY` and `FI_SECRET_KEY`, found under **Build → Keys** in the left sidebar.
