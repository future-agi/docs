...
- **In the SDK** — Pass the **model_name** (e.g. `turing_small`, `turing_flash`, `protect`) in your `evaluate()` call. See [Running your first eval](/docs/evaluation) for setup and usage.
