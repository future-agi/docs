...
<Tabs sync={false}>
  <Tab title="Using UI" icon="display">
    <Steps>
      ...
      <Step title="Configure basic settings">
        ...
        **Model** — **Use Future AGI Models** (e.g. turing_large, turing_flash, turing_small, protect, protect_flash) or **Use other LLMs** (your own or external providers). For model details, see [Future AGI models](/docs/evaluation/features/futureagi-models) and [Use custom models](/docs/evaluation/features/custom-models).
  ...
  <Tab title="Using SDK" icon="code">
    ...
    <Steps>
      ...
      <Step title="Create the custom eval template">
