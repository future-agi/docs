...
Manage roles and workspace membership in the platform UI under **Settings → Members** and **Settings → Workspaces**. See [Roles & Permissions](/docs/roles-and-permissions) for the full model.
