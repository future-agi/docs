...
<TLDR>
Doing a local trial? Skip to [Install](/docs/self-hosting/install). The defaults work as-is. Come back here when you're ready to set secrets, add LLM provider keys, or turn on email.
</TLDR>
