...
Simulation testing lets you run automated conversations against your voice AI agents using synthetic customer personas. Each simulation produces a transcript, optional audio recordings, and evaluation scores.
...
await runner.run_test(scenario=scenario, agent_callback=my_agent)
```
