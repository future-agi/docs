...
<Tabs>
  <Tab title="Python">
    ...
    # Requires FI_API_KEY and FI_SECRET_KEY in your environment
    evaluator = Evaluator()
    ...
    print(result)
    # [{"score": 0.95, "passed": True, "reason": "Professional tone detected"}]
    ```
...
50+ built-in metrics for things like tone, hallucination, bias, and factual accuracy. Also includes guardrails (toxicity, PII, prompt injection) that run in under 10ms.
