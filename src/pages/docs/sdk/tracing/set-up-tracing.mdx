...
<CardGroup cols={2}>
  ...
  <Card title="Instrument with TraceAI" icon="plug" href="/docs/sdk/tracing/instrument-with-traceai-helpers">
    Use TraceAI helpers for sessions, users, and context.
  </Card>
  <Card title="Add Attributes & Metadata" icon="tags" href="/docs/sdk/tracing/add-attributes-metadata-tags">
    Attach custom data to spans for filtering and evals.
  </Card>
  <Card title="Set Session & User ID" icon="table-rows" href="/docs/sdk/tracing/set-session-user-id">
    Group traces into sessions and link them to end users.
  </Card>
  <Card title="Mask Span Attributes" icon="shield" href="/docs/sdk/tracing/mask-span-attributes">
