...
<CardGroup cols={2}>
  ...
  <Card title="Instrument with traceAI Helpers" icon="plug" href="/docs/sdk/tracing/instrument-with-traceai-helpers">
    Use FITracer decorators and context managers for typed spans.
  </Card>
  <Card title="Add Events & Exceptions" icon="lightning" href="/docs/sdk/tracing/add-events-exceptions-status">
    Record exceptions and set span status for error visibility.
  </Card>
  <Card title="Get Current Span" icon="magnifying-glass" href="/docs/sdk/tracing/get-current-span-context">
