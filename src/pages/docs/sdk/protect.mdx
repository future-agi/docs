...
Protect runs safety checks on text before or after your LLM processes it. Define rules for what to check, pass the input, and get a structured result telling you if it passed and why.
...
| `completed_rules` | list | Rules that passed |
