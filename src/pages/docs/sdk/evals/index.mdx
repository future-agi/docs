...
<CardGroup cols={2}>
  ...
  <Card title="Metrics Reference" icon="list-check" href="/docs/sdk/evals/metrics">
    Browse all 72+ local metrics by category: string, JSON, similarity, hallucination, RAG, agents, guardrails.
  </Card>
  <Card title="Cloud Evals" icon="bolt" href="/docs/sdk/evals/cloud-evals">
    58 pre-built Turing templates for tone, toxicity, bias, factual accuracy, and more.
  </Card>
...
| Auto-generate an eval suite for your app | AutoEval — `AutoEvalPipeline.from_description("...")` |
| Run evals at scale with Celery/Ray | Framework evaluator |
...
<CardGroup cols={3}>
  <Card title="Running Evaluations" icon="play" href="/docs/sdk/evals/evaluate">
    Start here — the core API.
  </Card>
  <Card title="Metrics Reference" icon="list-check" href="/docs/sdk/evals/metrics">
    Browse 72+ metrics by category.
  </Card>
  <Card title="Cloud Evals" icon="bolt" href="/docs/sdk/evals/cloud-evals">
    58 pre-built Turing templates.
  </Card>
</CardGroup>
