...
related:
  ...
  - "/docs/sdk/tracing/add-attributes-metadata-tags"
  - "/docs/sdk/tracing/mask-span-attributes"
...
<CardGroup cols={2}>
  ...
  <Card title="Mask span attributes" icon="eye-slash" href="/docs/sdk/tracing/mask-span-attributes">
