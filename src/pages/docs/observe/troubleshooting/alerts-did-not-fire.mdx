...
related:
  - "/docs/observe/guides/setup-alerts"
...
<CardGroup cols={2}>
  <Card title="Alerts & monitors" icon="zap" href="/docs/observe/guides/setup-alerts">
    How monitors and thresholds are configured.
  </Card>
  <Card title="Dashboards" icon="chart-simple" href="/docs/observe/guides/explore-dashboard">
