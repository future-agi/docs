...
<CardGroup cols={2}>
  ...
  <Card title="Span types" icon="tags" href="/docs/observe/reference/span-types">
    The kinds a span can be: LLM, tool, retriever, and the rest
  </Card>
  <Card title="Create tool spans" icon="gear" href="/docs/traceai/manual-instrumentation/create-tool-spans">
