...
1. Auto Instrumentor : Instrument your project with FutureAGI's [Auto Instrumentor](/docs/products/observability/auto-instrumentation/overview). Recommended for most use cases.
2. Manual Tracing : Manually track your project with [Open Telemetry](/docs/products/observability/concept/otel). Useful for more customized tracing. [Learn more →](/docs/get-started/observability/manual-tracing/set-up-tracing)
...
To know more about the supported frameworks and how to instrument them, check out our [Auto Instrumentation](/docs/products/observability/auto-instrumentation/overview) page.
