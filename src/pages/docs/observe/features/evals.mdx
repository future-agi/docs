---
title: "Run Evals on Production Traces"
...
<Steps>
  ...
  <Step title="Set sampling rate and row limit">
    ...
    - **Row limit** — the maximum number of matching rows the task processes before it stops. The run stops at whichever cap is hit first.
  </Step>
  ...
  <Step title="Select evals and run">
    ...
    <img src="/images/docs/observe/evals-create.webp" alt="Selecting eval templates to attach to a task and running it" style={{ borderRadius: '5px' }} />
