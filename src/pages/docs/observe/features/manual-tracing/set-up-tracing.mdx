...
- **Any Python or JS/TS app**: Works with any application via OpenTelemetry. Auto-instrumentors cover a wide range of frameworks — see the [Auto Instrumentation catalog](/docs/tracing/auto).
