...
<Steps>
  ...
  <Step title="Create an agent definition with observability">
    ...
    *The API key and Assistant ID are only required when Observability is on.*
    ...
    <img src="/images/docs/observe/voice-agent-definitions.webp" alt="Agent definitions list showing the newly created voice agent" style={{ borderRadius: '5px' }} />
  ...
  <Step title="View call logs in Observe">
    ...
    <img src="/images/docs/observe/voice-tracing-overview.webp" alt="Voice project table listing calls with status, duration, and cost" style={{ borderRadius: '5px' }} />
    *Each row is a call, captured as a trace.*

    <img src="/images/docs/observe/voice-call-detail.webp" alt="Call detail drawer with transcript, recording URLs, and call metadata" style={{ borderRadius: '5px' }} />
