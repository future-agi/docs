...
<Note>
To get started with Observe, please follow the [Quickstart](/docs/products/observe/quickstart) guide.
</Note>
...
- **Session Management**: Group related traces for comprehensive analysis of multi-turn interactions, Useful for debugging chatbot applications. [Learn More ->](/docs/products/observe/session)
- **Alert System**: Configure customized alerts for real-time issue detection and notification. [Learn More ->](/docs/products/observe/alerts-and-monitors)