...
{/* Image not available: manually_creating.png */}
...
- **[Static Columns](/docs/dataset/create-static-column)**: Stores fixed values directly within a dataset.
- **[Dynamic Columns](/docs/dataset/create-dynamic-column)**: Generates values automatically and dynamically based on a defined criteria.
