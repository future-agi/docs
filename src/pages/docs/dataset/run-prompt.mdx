  ...
  <Step title="Choose model type and model">
    ...
    <Tabs>
      <Tab title="LLM" icon="robot">
        ...
        ![LLM](/screenshot/docs/dataset/run-prompt-in-dataset/3.png)
        <Tip>
      ...
      <Tab title="Text-to-Speech (TTS)" icon="microphone">
        ...
        ![Text-to-Speech](/screenshot/docs/dataset/run-prompt-in-dataset/4.png)
        <Tip>
          Click [here](/docs/evaluation/use-custom-models) to learn how to create custom models.
        </Tip>
      </Tab>
      <Tab title="Speech-to-Text (STT)" icon="page">
        ...
        ![Speech-to-Text](/screenshot/docs/dataset/run-prompt-in-dataset/5.png)
        <Tip>
          Click [here](/docs/evaluation/use-custom-models) to learn how to create custom models.
        </Tip>
      </Tab>
      <Tab title="Image Generation" icon="image">
        ...
        ![Image Generation](/screenshot/docs/dataset/run-prompt-in-dataset/6.png)
        <Tip>
          Click [here](/docs/evaluation/use-custom-models) to learn how to create custom models.
        </Tip>
      </Tab>
