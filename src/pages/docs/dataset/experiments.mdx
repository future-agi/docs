...
<Steps>
  <Step title="Navigate to Experiments">
    ...
    ![Experiments](/screenshot/docs/dataset/experiments-in-dataset/1.png)
  </Step>
  ...
  <Step title="Create a new experiment">
    ...
    ![Create Experiment](/screenshot/docs/dataset/experiments-in-dataset/2.png)
  </Step>
  ...
  <Step title="Prompt template">
    ...
    ![Prompt Template](/screenshot/docs/dataset/experiments-in-dataset/3.png)
    ...
    <Tabs>
      <Tab title="LLM" icon="robot">
        ...
        ![LLM](/screenshot/docs/dataset/experiments-in-dataset/4.png)
        <Tip>
          Click [here](/docs/evaluation/use-custom-models) to learn how to create a custom model.
        </Tip>
      </Tab>
      <Tab title="Text-to-Speech (TTS)" icon="microphone">
        ...
        ![TTS](/screenshot/docs/dataset/experiments-in-dataset/5.png)
        <Tip>
          Click [here](/docs/evaluation/use-custom-models) to learn how to create a custom model.
        </Tip>
      </Tab>
      <Tab title="Speech-to-Text (STT)" icon="page">
        ...
        ![STT](/screenshot/docs/dataset/experiments-in-dataset/6.png)
        <Tip>
          Click [here](/docs/evaluation/use-custom-models) to learn how to create a custom model.
        </Tip>
      </Tab>
      <Tab title="Image Generation" icon="image">
        ...
        ![Image Generation](/screenshot/docs/dataset/experiments-in-dataset/7.png)
        <Tip>
          Click [here](/docs/evaluation/use-custom-models) to learn how to create a custom model.
        </Tip>
      </Tab>
  ...
  <Step title="Choosing evals">
    ...
    ![Choosing Evals](/screenshot/docs/dataset/experiments-in-dataset/8.png)
    Click "Add Evaluation" and pick from [existing eval](/docs/evaluation/builtin/overview) templates or [create a custom eval](/docs/evaluation/create-custom-evals). You can add as many evals as you want.
    ![Choosing Evals](/screenshot/docs/dataset/experiments-in-dataset/9.png)
  </Step>
  ...
  <Step title="Update and re-run">
    ...
    ![Update](/screenshot/docs/dataset/experiments-in-dataset/10.png)
  </Step>
