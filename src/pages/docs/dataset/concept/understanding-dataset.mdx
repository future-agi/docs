...
- **Manual Creation:** Users can create datasets by **defining structure and adding data manually**. [Learn more →](/docs/dataset/features/create)
...
- **Importing from External Sources:** Future AGI supports imports from **CSV, Excel, JSON, JSONL**, and **Hugging Face datasets**. [Learn more →](/docs/dataset/features/create)
