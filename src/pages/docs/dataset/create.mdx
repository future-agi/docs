...
<Steps>
  <Step title="Assign Dataset Name">
    ...
    ![assign_dataset_name](/screenshot/docs/dataset/create-new-dataset/1.png)
  </Step>
...
<Steps>
  <Step title="Upload CSV, JSON or JSONL files to create a dataset.">
    ![upload_file](/screenshot/docs/dataset/create-new-dataset/2.png)
  </Step>
</Steps>
  </Tab>
...
<Steps>
  <Step title="Add Details">
    ...
    ![add_details](/screenshot/docs/dataset/create-new-dataset/3.png)
  ...
  <Step title="Add Column Properties">
    ...
    ![add_column_properties](/screenshot/docs/dataset/create-new-dataset/4.png)
  ...
  <Step title="Add Description">
    ...
    ![add_column_description](/screenshot/docs/dataset/create-new-dataset/5.png)
  </Step>
  <Step title="Create Dataset">
    ...
    ![create_dataset](/screenshot/docs/dataset/create-new-dataset/6.png)
    ![configure_synthetic_data](/screenshot/docs/dataset/create-new-dataset/7.png)
...
<Steps>
  <Step title="Provide Basic Details">
    ...
    ![manually](/screenshot/docs/dataset/create-new-dataset/8.png)
    You will be greeted with an empty dataset with the name you assigned and with empty rows and columns.
    ![empty_dataset](/screenshot/docs/dataset/create-new-dataset/9.png)
  </Step>
  <Step title="Populating the dataset">
      ...
      ![populate_dataset](/screenshot/docs/dataset/create-new-dataset/10.png)
  </Step>
</Steps>
  </Tab>
...
<Steps>
  <Step title="Search Hugging Face Dataset">
    ...
    ![search_hugging_face_dataset](/screenshot/docs/dataset/create-new-dataset/11.png)
  </Step>
  <Step title="Import Dataset">
    ...
    ![import_dataset](/screenshot/docs/dataset/create-new-dataset/12.png)
...
<Steps>
  <Step title="Choose the existing dataset">
    ...
    ![choose_existing_dataset](/screenshot/docs/dataset/create-new-dataset/13.png)
  ...
  <Step title="Map the columns">
    ...
    ![map_columns](/screenshot/docs/dataset/create-new-dataset/14.png)
