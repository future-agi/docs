...
- **How-To Guides:** Step-by-step instructions for dataset building and management, including:
    ...
    - [**Changing column types**](/docs/dataset/change-column-type) to adapt to different data requirements.
    - [**Creating static columns**](/docs/dataset/create-static-column) for fixed value data entries.
    - [**Creating dynamic columns**](/docs/dataset/create-dynamic-column) for automated data processing and transformation.
    - [**Adding data using the SDK**](/docs/dataset/adding-dataset/using-sdk) for seamless integration.
    - [**Uploading datasets (JSON, CSV)**](/docs/dataset/adding-dataset/upload-file) for structured data ingestion.
    - [**Manually creating datasets**](/docs/dataset/adding-dataset/manually-creating) for custom data structuring.
    - [**Importing datasets from Hugging Face**](/docs/dataset/adding-dataset/by-importing-through-huggingface) to leverage pre-existing models.
    - [**Adding data from existing datasets/experiments**](/docs/dataset/adding-dataset/from-existing-dataset) for iterative improvements.
...
<CardGroup>
<Card title="Understanding Datasets" icon="table" href="/docs/dataset/concept/understanding-dataset">
Learn about how to effectively use dataset feature of Future AGI
</Card>
<Card title="Static Columns" icon="table" href="/docs/dataset/concept/static-column">
Learn about fixed value columns and their uses
</Card>
<Card title="Dynamic Columns" icon="bolt" href="/docs/dataset/concept/dynamic-column">
...
<CardGroup>
<Card title="Change Column Type" icon="arrows-rotate" href="/docs/dataset/change-column-type">
Modify existing column data types
</Card>
<Card title="Create Static Column" icon="plus" href="/docs/dataset/create-static-column">
Add new fixed value columns
</Card>
<Card title="Create Dynamic Column" icon="wand-magic-sparkles" href="/docs/dataset/dynamic-column/using-run-prompt">
