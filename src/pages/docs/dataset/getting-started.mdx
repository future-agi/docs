...
- **How-To Guides:** Step-by-step instructions for dataset building and management, including:
    ...
    - [**Creating dynamic columns**](/docs/dataset/features/add-columns) for automated data processing and transformation.
    - [**Adding data using the SDK**](/docs/dataset/features/create) for seamless integration.
    - [**Uploading datasets (JSON, CSV)**](/docs/dataset/features/create) for structured data ingestion.
    - [**Manually creating datasets**](/docs/dataset/features/create) for custom data structuring.
    - [**Importing datasets from Hugging Face**](/docs/dataset/features/create) to leverage pre-existing models.
    - [**Adding data from existing datasets/experiments**](/docs/dataset/features/create) for iterative improvements.
...
<Card title="Create Dynamic Column" icon="wand-magic-sparkles" href="/docs/dataset/features/add-columns">
