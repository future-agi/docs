...
<Steps>
  <Step title="Add Details">
    ...
    | Knowledge Base (optional)    | Select which <Tooltip tip="Useful for grounded, context-aware synthetic data generation and accurate evaluations." cta="Learn more about knowledge base" href="/docs/knowledge-base/concepts/concept">knowledge base</Tooltip> you want to use. |
