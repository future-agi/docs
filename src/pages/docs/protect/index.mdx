...
- **Command Center Gateway**: Protect's safety dimensions can also be applied as guardrails in the Command Center gateway for all LLM traffic. [Learn more](/docs/command-center/features/guardrails)
