...
Access: Owners, Admins, and Workspace Admins can open the Keys page. Only an Owner can delete a key.

## How to

<Steps>
  <Step title="Open Settings">
    Navigate to **Settings > Keys** at [https://app.futureagi.com/dashboard/settings/api_keys](https://app.futureagi.com/dashboard/settings/api_keys).
  </Step>
