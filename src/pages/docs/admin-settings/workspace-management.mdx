...
<Warning>
Managing workspace members still follows the organization role. A Workspace Admin whose organization role is Member can act on the people in their workspace whose organization role is Viewer, and every other row is disabled with *You cannot manage a user at or above your own level.* If you need to change someone at or above your own organization role, ask an Owner or Admin.
</Warning>
...
<CardGroup cols={3}>
  ...
  <Card title="AI Providers" href="/docs/admin-settings/ai-providers" icon="plug">
    Configure LLM providers per workspace
  </Card>
  <Card title="Integrations" href="/docs/admin-settings/integrations" icon="puzzle">
