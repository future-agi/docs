...
Each workspace can have its own integrations. To send one workspace's traces to Langfuse and leave the others alone, go to **Settings > Workspaces > [workspace name] > Integrations** and add the connection there rather than at the organization.
