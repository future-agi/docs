---
title: "Frequently Asked Questions about Future AGI Products"
description: "Find answers to frequently asked questions about Future AGI products, pricing, features, SDK setup, and platform usage."
---
...
In the left sidebar, open **Build > Keys**. See [API Keys](/docs/admin-settings/api-keys).
...
Open [Build > Keys](https://app.futureagi.com/dashboard/keys) in the left sidebar.

Two things make keys look missing. **The page only lists the keys of the workspace you currently have open**, so if it says *No keys has been added yet* and you know you made one, switch workspace in the switcher at the top of the sidebar and look again. And if **Keys** is not in your sidebar at all, your role cannot reach the page: it is open to Owners, Admins, and Workspace Admins, so ask one of them.

All three can add and disable keys. Only an Owner can delete one. See [API Keys](/docs/admin-settings/api-keys).
