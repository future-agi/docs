...
Go to Settings > Keys. See [API Keys](/docs/admin-settings/api-keys).
...
Go to [Settings > Keys](https://app.futureagi.com/dashboard/settings/api_keys). Owners, Admins, and Workspace Admins can open it, and only an Owner can delete a key. See [API Keys](/docs/admin-settings/api-keys).
