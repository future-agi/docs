...
Open [Build > Keys](https://app.futureagi.com/dashboard/keys) in the left sidebar. Owners, Admins, and Workspace Admins can open it, and only an Owner can delete a key. See [API Keys](/docs/admin-settings/api-keys).
