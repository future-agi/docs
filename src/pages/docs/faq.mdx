...
Open [Build > Keys](https://app.futureagi.com/dashboard/keys) in the left sidebar. Owners, Admins, and Workspace Admins can open it, and all three can add, disable, and delete keys. See [API Keys](/docs/admin-settings/api-keys).
