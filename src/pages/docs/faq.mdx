...
Open [Build > Keys](https://app.futureagi.com/dashboard/keys) in the left sidebar. Owners, Admins, and Workspace Admins can open it, and all three can add and disable keys. Only an Owner can delete one. See [API Keys](/docs/admin-settings/api-keys).
