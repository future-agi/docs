...
Open [Build > Keys](https://app.futureagi.com/dashboard/keys) in the left sidebar. The page is open to Owners and Admins. If **Keys** is not in your sidebar, your role cannot reach it, so ask an Owner or Admin. See [API Keys](/docs/admin-settings/api-keys).
