    ...
    <Tabs sync={false}>
      <Tab title="Random Search" icon="shuffle">
        ...
        **Limitations:** No learning from previous attempts; may miss optimal solutions; quality depends on teacher model.
        ...
        [Random Search →](/docs/optimization/random-search)
      </Tab>
      <Tab title="Bayesian Search" icon="chart-line">
        ...
        **Limitations:** Requires examples in your dataset; may need many trials for complex spaces; best for structured tasks.
        ...
        [Bayesian Search →](/docs/optimization/bayesian-search)
      </Tab>
    </Tabs>
  </Tab>
    ...
    <Tabs sync={false}>
      <Tab title="Meta-Prompt" icon="brain">
        ...
        **Limitations:** Slower than search-based; higher API cost; may overfit to eval set.
        ...
        [Meta-Prompt →](/docs/optimization/meta-prompt)
      </Tab>
      <Tab title="ProTeGi" icon="microscope">
        ...
        **Limitations:** Can be expensive; needs clear failure signals; may need several rounds.
        ...
        [ProTeGi →](/docs/optimization/protegi)
      </Tab>
      ...
      <Tab title="PromptWizard" icon="wand-magic-sparkles">
        ...
        **Limitations:** Multiple stages can be slow; requires a good teacher model; may produce unconventional prompts.
        ...
        [PromptWizard →](/docs/optimization/promptwizard)
      </Tab>
    </Tabs>
  </Tab>
...
<CardGroup cols={2}>
  <Card title="Bayesian Search" icon="chart-line" href="/docs/optimization/bayesian-search">
