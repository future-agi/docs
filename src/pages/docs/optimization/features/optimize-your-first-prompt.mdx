...
- **Stepping stone to SDK** — Once this runs, you can move on to [Using the Python SDK](/docs/optimization/features/using-python-sdk) for more options.
...
<CardGroup cols={2}>
  <Card title="Optimization fundamentals" icon="chart-line" href="/docs/optimization/optimizers/overview">
