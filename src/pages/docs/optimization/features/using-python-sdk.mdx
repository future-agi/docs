...
<Steps>
  ...
  <Step title="Choose and initialize an optimizer">
    ...
    **Example: Meta-Prompt (deep reasoning)**
    ...
    For a detailed comparison, see the [Optimizers overview](/docs/optimization/optimizers/overview).
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Optimizers overview" icon="chart-line" href="/docs/optimization/optimizers/overview">
