...
<CardGroup cols={2}>
  <Card title="Try Meta-Prompt" icon="brain" href="/docs/optimization/meta-prompt">
    For tasks that need deeper reasoning and full rewrites.
  </Card>
  <Card title="Compare Optimizers" icon="scale-balanced" href="/docs/optimization/overview">
