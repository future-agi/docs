...
<img src="/images/docs/optimization/run-detail-trial-list.png" alt="A completed GEPA run showing the score graph from Baseline through Trial 8, the improvement note and View Column bar, and the trial list with Trial 2 flagged at plus 10 percent" style={{ borderRadius: '5px' }} />
...
<img src="/images/docs/optimization/trial-detail-show-diff.png" alt="The winning trial's Prompt tab with Show Diff on, the baseline Agent Prompt on the left with removals in red and the Optimized Agent Prompt on the right with additions in green, headed by a plus 10 pts improved from baseline prompt chip" style={{ borderRadius: '5px' }} />
