...
- **Run automatic evaluations** — Evaluate batch and single inputs on various [evaluation](https://docs.futureagi.com/docs/evaluation/running-your-first-eval) metrics present in Future AGI both on local datapoints and large datasets
- **Prototype and Observe your Agents** —  You can add [observability](https://docs.futureagi.com/docs/observe/quickstart), evaluations while both [prototyping](https://docs.futureagi.com/docs/prototype/overview) and deploying your agents into production using natural language
- **Manage datasets** — Upload, evaluate, download [datasets](https://docs.futureagi.com/docs/dataset/overview) and find insights with natural language
