...
- **Run automatic evaluations** — Evaluate batch and single inputs on various [evaluation](/docs/get-started/evaluation/running-your-first-eval) metrics present in Future AGI both on local datapoints and large datasets
- **Prototype and Observe your Agents** —  You can add [observability](/docs/products/observe/quickstart), evaluations while both [prototyping](/docs/get-started/prototype/overview) and deploying your agents into production using natural language
- **Manage datasets** — Upload, evaluate, download [datasets](/docs/get-started/dataset/overview) and find insights with natural language
