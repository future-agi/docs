...
<Steps>
  ...
  <Step title="Instrument Your Project">
    ...
    2. **Manual Tracing**: Manually track your project with Open Telemetry. Useful for more customized tracing. [Learn more →](/docs/get-started/observability/manual-tracing/set-session-user-id)
