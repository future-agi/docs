...
We recommend starting with [Auto instrumentation](/docs/tracing/auto) for your agent as it's the quickest way to get set up, gives you full coverage, and avoids manually adding custom events
