...
Environment variables are the same regardless of language:
...
Open the [Future AGI dashboard](https://app.futureagi.com), select your **`my-llm-app`** project, and open the **Tracing** tab. Open the latest trace and confirm you can see:
