...
- [Trace a different framework](/docs/tracing/auto): traceAI supports Anthropic, LangChain, LlamaIndex, and 30+ more, with the same four steps
- [Run an eval on this trace](/docs/observe/features/evals) to start scoring quality
