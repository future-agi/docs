...
<CardGroup cols={2}>
  <Card title="Run the prompt over a dataset" icon="database" href="/docs/dataset/features/run-prompt">
    Test the prompt at scale across a dataset
  </Card>
  <Card title="Fetch the prompt via the SDK" icon="code" href="/docs/prompt/features/sdk">
