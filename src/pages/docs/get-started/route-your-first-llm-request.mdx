...
Create an Agent Command Center API key in **Gateway → API Keys** and copy the value that starts with `sk-agentcc-`:
...
- **Authentication error**: confirm your key starts with `sk-agentcc-` (Gateway → API Keys)
