...
description: "Everything in the right-side metadata panel on an issue detail page — triage controls, cluster stats, timeline, AI metadata, evaluations, co-occurring issues, and integrations."
---
