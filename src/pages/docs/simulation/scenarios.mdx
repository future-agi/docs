...
<Steps>
  <Step title="Navigate to Scenarios">
    ...
    ![Add Scenario Button](/screenshot/docs/simulation/scenarios/1.png)
  </Step>
  <Step title="Choose scenario type">
    ...
    ![Scenario Type Selection](/screenshot/docs/simulation/scenarios/2.png)
  </Step>
</Steps>
...
<Tabs sync={false}>
  <Tab title="Workflow Builder" icon="git-branch">
    ...
    **Option A – Auto-generate**
    <Steps>
      ...
      <Step title="Generate">
        ...
        ![Workflow Type Selection](/screenshot/docs/simulation/scenarios/3.png)
      </Step>
    </Steps>
    ...
    **Option B – Manual graph**
    <Steps>
      ...
      <Step title="Save">
        ...
        ![Create Graph](/screenshot/docs/simulation/scenarios/4.png)
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="Upload Script" icon="file-lines">
    **What it is:** Paste or upload a call script (customer and agent lines). The system builds a graph and generates personas, situations, and outcomes from the script. Ideal for compliance or specific dialogue tests.
    ...
    <Steps>
      ...
      <Step title="Add script content">
        ...
        ![Script Scenario Interface](/screenshot/docs/simulation/scenarios/5.png)
      </Step>
      <Step title="Save">
  ...
  <Tab title="Call / Chat SOP" icon="list-check">
    **What it is:** Define a Standard Operating Procedure (steps and expectations). The system turns the SOP into a graph and scenario rows. Good for consistency, compliance, and training.
    ...
    <Steps>
      ...
      <Step title="Enter SOP content">
        ...
        ![Chat SOP Interface](/screenshot/docs/simulation/scenarios/6.png)
      </Step>
      <Step title="Save">
...
![Scenario Detail view](/screenshot/docs/simulation/scenarios/7.png)
...
<Tabs sync={false}>
  <Tab title="Scenario overview" icon="layout">
  ...
  <Tab title="Edit graph" icon="pen">
    **What it is:** The workflow editor for scenarios that have a graph. You can add, delete, and edit nodes and change connections between them.
    ![Scenario Graph Edit](/screenshot/docs/simulation/scenarios/8.png)
  ...
  <Tab title="Edit prompt" icon="message">
    ...
    **What you see:** In the prompt editor, variables that match a column in the scenario table are highlighted (e.g. green = column exists; red = column missing and should be added or generated). Ensure every variable you use in the prompt exists as a column in the scenario table.
    ...
    ![Scenario Prompt Edit](/screenshot/docs/simulation/scenarios/9.png)
    <Steps>
      ...
      <Step title="Save">
        Save your changes.
        ![Scenario Prompt Edit](/screenshot/docs/simulation/scenarios/10.png)
      </Step>
    </Steps>
  </Tab>
  <Tab title="Scenario table" icon="table">
    ...
    **Add rows – process:**
    ...
    <Steps>
      <Step title="Open Add rows">
        ...
        ![Scenario Add Rows](/screenshot/docs/simulation/scenarios/11.png)
      </Step>
      <Step title="Choose how to add">
        - **From existing dataset or experiment** – Pick a dataset, map its columns to the scenario columns, and add the rows.
          ![Scenario Add Rows Existing Dataset](/screenshot/docs/simulation/scenarios/12.png)
        - **Generate using AI** – Enter a prompt; the system generates new rows based on it.
          ![Scenario Add Rows Using AI](/screenshot/docs/simulation/scenarios/13.png)
        - **Add empty rows** – Add blank rows and fill them in manually.
          ![Scenario Add Rows Manual](/screenshot/docs/simulation/scenarios/14.png)
      </Step>
      <Step title="Confirm">
    ...
    **Delete rows:** Select rows using the checkboxes, then use the delete action. Selected rows are removed from the scenario.
    ![Scenario Delete rows](/screenshot/docs/simulation/scenarios/15.png)
  </Tab>
</Tabs>
