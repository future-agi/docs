...
<Steps>
  ...
  <Step title="Provide basic information">
    ...
    ![Agent Definitions Page](/screenshot/docs/simulation/agent-definition/1.png)
  ...
  <Step title="Define agent behavior">
    ...
    ![Agent Definitions Page](/screenshot/docs/simulation/agent-definition/4.png)
    ...
    <Tip>
      Learn more in the [Knowledge base overview](/docs/knowledge-base/overview).
    </Tip>
  </Step>
...
![Agent detail](/screenshot/docs/simulation/agent-definition/5.png)
...
<Tabs sync={false}>
  <Tab title="Agent config" icon="settings">
    ...
    ![Agent config](/screenshot/docs/simulation/agent-definition/6.png)
    ...
    **Process – step by step:**
    ...
    <Steps>
      <Step title="Create a new version">
        ...
        ![Create new version](/screenshot/docs/simulation/agent-definition/7.png)
      ...
      <Step title="Switch to a different version">
        ...
        ![Switch version](/screenshot/docs/simulation/agent-definition/8.png)
  ...
  <Tab title="Performance analytics" icon="chart-line">
    **What it is:** The **Performance analytics** tab shows how this agent is performing across test runs in one place. The data comes from completed call executions and their evaluation results for this agent (and can be filtered by version).
    ![Performance analytics](/screenshot/docs/simulation/agent-definition/9.png)
    **What you see:**
  ...
  <Tab title="Call logs" icon="phone">
    ...
    **What each row shows:**
    ...
    ![Call logs](/screenshot/docs/simulation/agent-definition/10.png)
    **Process – how to inspect a call:**
    ...
    <Steps>
      ...
      <Step title="Open call detail">
        ...
        ![Call detail](/screenshot/docs/simulation/agent-definition/11.png)
      </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Run simulation" icon="play" href="/docs/simulation/run-tests">
