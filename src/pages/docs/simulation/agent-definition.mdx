...
<Steps>
  ...
  <Step title="Agent Configuration">
    This section is useful if you want to setup <Tooltip tip="Voice observability allows you to monitor, track, and analyze voice interactions with your agent in real-time." cta="Learn more about voice observability" href="/docs/simulation/how-to/voice-observability">voice observability</Tooltip> for your agent.

    ![Agent Definitions Page](/screenshot/product/simulation/agent-definition/3.png)

    | Field | Description |
    |-------|-------------|
    | Voice/Chat Provider| Choose the provider for your agent. Click [here](/docs/integrations/overview#voice) to find out more about the supported providers. |
  ...
  <Step title="Define Agent Behavior">
    ...
    **Knowledge Base (optional):** Provide domain-specific information to help agent behaviour as per your business use-case. 
    <Tip>
    Click [here](/docs/get-started/knowledge-base/overview) to learn more about knowledge base.
    </Tip>
