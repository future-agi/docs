...
<Step title="Agent Definition">
  ...
  <Step title="Scenarios">
    ...
    <Tip>
    Click [here](https://docs.futureagi.com/docs/simulation/scenarios) to learn how to create and manage scenarios.
    </Tip>
  </Step>
...
---
## Next Steps
Learn how to get started with simulations in our [Getting Started](/docs/simulation/getting-started) guide.