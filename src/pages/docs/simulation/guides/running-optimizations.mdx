...
<img src="/images/docs/simulation/guides/running-optimizations/optimize-drawer.png" alt="The Choose optimization type dialog filled in with a name, Random Search as the optimizer, gpt-4.1 as the language model, three variations, and an optimization objective written out" style={{ borderRadius: '5px' }} />
