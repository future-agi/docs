...
<img src="/images/docs/simulation/guides/optimization-runs/optimization-steps.png" alt="A completed GEPA optimization run, showing the Optimization Results chart across the baseline and seven trials, and the trials table with an improvement percentage against each one" style={{ borderRadius: '5px' }} />
