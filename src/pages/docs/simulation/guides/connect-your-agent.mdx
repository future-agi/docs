...
<img src="/images/docs/simulation/guides/connect-your-agent/connect-3.png" alt="The Configuration step with the provider dropdown open, listing Vapi, Retell, Bland.ai, and Others" style={{ borderRadius: '5px' }} />
