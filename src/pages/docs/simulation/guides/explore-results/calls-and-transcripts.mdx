...
<img src="/images/docs/simulation/guides/explore-results/call-log-details.png" alt="The call drawer open on one completed outbound voice call, with the recording waveform and transcript on the left, the call's chips and Call Analytics on the right, and the cost breakdown beneath them" style={{ borderRadius: '5px' }} />
