...
<Warning>
Tool call evaluation only works for agents on **Vapi**. Turning it on for a chat agent, or for a voice agent on Retell, leaves nothing to evaluate, even though Retell is a supported [voice provider](/docs/simulation/reference/voice-providers) for the rest of Simulation.
</Warning>
...
<CardGroup cols={3}>
  ...
  <Card title="Voice providers" icon="microphone" href="/docs/simulation/reference/voice-providers">
    What Vapi and Retell each support in Simulation
  </Card>
</CardGroup>
