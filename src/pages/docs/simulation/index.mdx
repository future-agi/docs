...
<Step title="Define Agent">
    ...
    <Tip>
    Click [here](/docs/simulation/agent-definition) to learn how to create an agent definition.
    </Tip>
  </Step>
  <Step title="Create Personas">
    ...
    <Tip>
    Click [here](/docs/simulation/personas) to learn how to create and manage personas.
    </Tip>
  </Step>
  ...
  <Step title="Create Scenarios">
    ...
    <Tip>
    Click [here](/docs/simulation/scenarios) to learn how to create and manage scenarios.
    </Tip>
  </Step>
  <Step title="Simulate">
    ...
    <Tip>
    Click [here](/docs/simulation/run-tests) to learn how to run tests.
    </Tip>
  </Step>
</Steps>
