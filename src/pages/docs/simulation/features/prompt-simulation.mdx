...
Before you start: have a **prompt template** with at least one saved **prompt version** and at least one **scenario** (see [Scenarios](/docs/simulation/set-up/scenarios)).
