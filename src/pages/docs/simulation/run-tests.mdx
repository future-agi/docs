...
For advanced topics:
- [Creating Custom Evaluations](/docs/get-started/evaluation/create-custom-evals)
- [Test Automation & CI/CD](/docs/get-started/evaluation/evaluate-ci-cd-pipeline)
- [Advanced Analytics](/docs/get-started/evaluation/running-your-first-eval#analyzing-results)