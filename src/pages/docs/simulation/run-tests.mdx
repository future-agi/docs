...
![Create Test Button](/screenshot/docs/simulation/scenarios/12.png)
...
![Test Name Field](/screenshot/docs/simulation/scenarios/13.png)
...
![Scenario Search](/screenshot/docs/simulation/scenarios/14.png)
...
![No Scenarios Empty State](/screenshot/docs/simulation/scenarios/scenario-empty-list.png)
...
![Select Test Agent Screen](/screenshot/docs/simulation/scenarios/17.png)
...
![Agent Search Bar](/screenshot/docs/simulation/scenarios/18.png)
...
![Agent Selection Card](/screenshot/docs/simulation/scenarios/19.png)
...
![No Agents Empty State](/screenshot/docs/simulation/scenarios/20.png)
...
![Select Evaluations Screen](/screenshot/docs/simulation/scenarios/image.png)

<Tip>
You can also evaluate the tool calling capabilities of your agent by selecting the "Tool Calling" evaluation. Click [here](/docs/simulation/how-to/evaluate-tool-calling) to learn more about how to evaluate the tool calling capabilities of your agent.
</Tip>
#### Important Notice
...
![Evaluation Warning Banner](/screenshot/docs/simulation/scenarios/22.png)
...
![Add Evaluations Empty State](/screenshot/docs/simulation/scenarios/select-evaluation-screen.png)

**Evaluation Selection Dialog**
Clicking "Add Evaluations" opens a comprehensive dialog:

![Evaluation Selection Dialog](/screenshot/docs/simulation/scenarios/evaluation-selection-dialog.png)
...
![Selected Evaluations List](/screenshot/docs/simulation/scenarios/selected-evaluation-list.png)
...
![Evaluation Mapping](/screenshot/docs/simulation/scenarios/eval-configuration.png)
...
![Test Creation Summary](/screenshot/docs/simulation/scenarios/test-summary.png)
...
![Test List View](/screenshot/docs/simulation/scenarios/test-list-view.png)
...
![Test Run Tab](/screenshot/docs/simulation/scenarios/test-runs-tab.png)
...
![Test Run Select](/screenshot/docs/simulation/scenarios/test-run-select.png)

Once you have test runs selected you will get a option to Run Evals. Click on this button to open the evaluation page.

![Test Run Evals Page](/screenshot/docs/simulation/scenarios/test-run-evals-page.png)
...
![Test Run Evals Select](/screenshot/docs/simulation/scenarios/test-run-select-eval.png)
...
![Call Logs Tab](/screenshot/docs/simulation/scenarios/call-logs-tab.png)
...
![Analytics Tab](/screenshot/docs/simulation/scenarios/analytics.png)
...
![Analytics Tab](/screenshot/docs/simulation/scenarios/call-insights.png)
...
![Rerun All Tests](/screenshot/docs/simulation/scenarios/rerun-all-tests.png)
...
![Stop All Tests](/screenshot/docs/simulation/scenarios/stop-all-tests.png)
You can also select specific calls from the table using the checkbox and rerun those tests again
![Select Test To Run](/screenshot/docs/simulation/scenarios/select-test-to-rerun.png)
...
![Rerun Test Type](/screenshot/docs/simulation/scenarios/rereun-test-type.png)
...
For advanced topics:
- [Creating Custom Evaluations](/docs/evaluation/create-custom-evals)
- [Test Automation & CI/CD](/docs/evaluation/evaluate-ci-cd-pipeline)
- [Advanced Analytics](/docs/evaluation/running-your-first-eval#analyzing-results)