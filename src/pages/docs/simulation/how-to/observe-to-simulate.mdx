...
<CardGroup cols={2}>
  <Card title="Chat Simulation Using SDK" icon="code" href="/docs/simulation/how-to/chat-simulation-sdk">
    Run replayed (and other) chat simulations from your environment.
  </Card>
  <Card title="Run simulation" icon="play" href="/docs/simulation/run-tests">
    Create and manage run tests and view executions.
  </Card>
  ...
  <Card title="Agent definition" icon="robot" href="/docs/simulation/agent-definition">
    Configure the chat agent used for replay and simulation.
  </Card>
</CardGroup>
