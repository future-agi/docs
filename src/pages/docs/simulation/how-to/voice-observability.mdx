...
Unlike tracing a regular agent, tracing a voice agent is relatively simpler and does not require the use of FutureAGI SDK. All you will need is the provider API key and the Assistant Id to start observing your voice agent. Head over to [Quickstart](/docs/observe/voice/quickstart) to setup your first voice observability project
...
You can find the list of [supported providers](/docs/observe/voice/quickstart#list-of-supported-providers) at the end of this page

## Setting up

### 1. Creating an agent definition
- To create a new agent definition, head over to the agent definition section of platform
![Agent definition list](/screenshot/docs/observe/voice/agent_definition_list.png)
...
![Create agent definition form](/screenshot/docs/observe/voice/agent_definition_filled.png)
...
![Agent definition details](/screenshot/docs/observe/voice/agent_definition_details.jpeg)
...
![Agent definition details](/screenshot/docs/observe/voice/agent_definition_list_with_new.jpeg)
...
|![Agent update form observability disabled](/screenshot/docs/observe/voice/agent_update_observability_disabled.png)|
| :--: |
| **Agent with observability disabled** |

|![Agent update form observability enabled](/screenshot/docs/observe/voice/agent_update_observability_enabled.png)|
| :--: |
