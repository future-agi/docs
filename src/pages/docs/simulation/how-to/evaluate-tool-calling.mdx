...
<Steps>
  ...
  <Step title="Turn on tool call evaluation">
    ...
    ![Enable tool call evaluation](/screenshot/docs/simulation/how-to/evaluate-tool/1.png)
  </Step>
  <Step title="Provide API Key and Assistant ID when prompted (voice only)">
    ...
    ![Provide API Key and Assistant ID](/screenshot/docs/simulation/how-to/evaluate-tool/2.png)
  </Step>
...
<CardGroup cols={2}>
  <Card title="Run simulation" icon="play" href="/docs/simulation/how-to/run-simulation">
