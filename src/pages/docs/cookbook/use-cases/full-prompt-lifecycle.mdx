...
Every version is immutable. As your prompt evolves (v3 adds parental leave policy, v4 adds a new office location), this history becomes your changelog. Run the same cycle each time: optimize, test, promote. Once the prompt is stable, you can add safety guardrails with [Protect](/docs/cookbook/use-cases/secure-ai-evals-guardrails) and wire quality scoring into production with [inline evals and tracing](/docs/cookbook/use-cases/production-quality-monitoring).
