...
This metric is your first line of defense, and importantly, it doesn't need a reference query. You can use it even when you don't have gold-standard SQL to compare against.
