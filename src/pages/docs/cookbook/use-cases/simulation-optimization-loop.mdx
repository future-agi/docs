...
<Warning>
**MEDIA TODO - Screen Recording:** Navigate to **Simulate** > **Agent Definition** > click `my-support-agent` > click **Create new version**. Record: (1) pasting the optimized prompt, (2) entering the commit message, (3) clicking **Create**. Then: (4) navigate to **Run Simulation** > **Create a Simulation**, (5) enter name `optimized-v2`, (6) select `my-support-agent` v2 and the scenario, (7) click **Run Simulation**. End recording after the SDK code snippet is shown. Save as `step-6-create-v2-simulation.mp4`.
</Warning>
