...
Once the evaluation completes, open the dataset in the dashboard to review. Each row now has a Pass/Fail score and a reason. With the naive Rule Prompt, you will typically see results like the following (your exact results may vary):
...
<Warning>
**MEDIA TODO: Screen Recording.** Navigate to **Annotations** (left sidebar under OBSERVE) → **Labels** tab. Record: (1) clicking **Create Label**, (2) entering name `Human Verdict`, selecting type **Categorical**, adding 4 options: "Agree with AI", "Disagree - Actually Safe", "Disagree - Actually Violating", "Ambiguous", enabling **Allow Notes**, (3) clicking **Create**, (4) repeating for `Disagreement Reason` (type: Text) and `Confidence` (type: Numeric, min 1, max 5). Save as `step-3-create-labels.mp4`.
</Warning>
...
<Warning>
**MEDIA TODO: Screen Recording.** Navigate to **Annotations** → **Queues** tab. Record: (1) clicking **Create Queue**, (2) entering name "Content Moderation Review", description, (3) selecting the 3 labels, (4) adding annotators, (5) setting submissions per item to 1, (6) pasting the instructions, (7) clicking **Create annotation queue**. Save as `step-3-create-queue.mp4`.
</Warning>
...
<Warning>
**MEDIA TODO: Screen Recording.** Record: (1) opening the Content Moderation Review queue, (2) clicking **Add Items** → **From Datasets** → selecting `content-moderation-posts` → confirming, (3) clicking **Start Annotating**, (4) annotating 2-3 posts (selecting Human Verdict, typing a Disagreement Reason, setting Confidence, clicking Submit). Save as `step-3-annotate-posts.mp4`.
</Warning>
...
<Warning>
**MEDIA TODO: Screen Recording.** Record: (1) opening the Content Moderation Review queue, (2) clicking **Export to Dataset**, (3) selecting `content-moderation-posts` as target, (4) confirming the export. Save as `step-4-export-to-dataset.mp4`.
</Warning>
