...
This cookbook sets up that monitoring pipeline for HomeKey's production assistant. You will trace every LLM call and tool invocation, attach inline quality evals to score each response automatically, configure alerts for latency spikes and error rates, use Agent Compass to cluster failures into actionable patterns, and add Protect guardrails to block unsafe outputs before they reach users.
...
Q: Where is my order ORD-12345?
A: Your order ORD-12345 has been shipped! The tracking number is 1Z999AA10123456784, and the estimated delivery date is March 18,...

Q: What's your return policy?
A: I don't have access to return policy information through my available tools. I'd recommend checking the website or contacting...
```
...
An alert tells you something broke, but not what to fix. Alerts tell you *that* something is wrong. Agent Compass tells you *what* is wrong and *why*, by analyzing your traces across four quality dimensions and clustering similar failures into named patterns.
