---
title: "Multi-Agent Research System with CrewAI and Future AGI"
description: "Build a multi-agent research system using CrewAI with Future AGI observability and in-line evaluations for real-time quality monitoring."
---
...
💡 **Have questions?** Open an issue on [GitHub](https://github.com/future-agi/future-agi) or reach the team from the dashboard.
