---
title: "Creating and Managing Datasets with the Future AGI SDK"
description: "Create and manage AI evaluation datasets using the Future AGI Python SDK. Define schema columns, add rows, and access datasets via the futureagi package."
---
