---
title: "Guarding LLM Outputs with Future AGI Protect Rules"
description: "Apply guardrail rules to LLM outputs with the Future AGI Protect class. Define tone, toxicity, and custom metric rules to block or flag harmful responses."
---
