---
title: "Managing Knowledge Bases with the Future AGI Python SDK"
description: "Initialize a KnowledgeBase client with the Future AGI SDK to create and manage knowledge bases, add files, update contents, and query stored documents."
---
