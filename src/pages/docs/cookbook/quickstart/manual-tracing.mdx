...
tags:
  ...
  - "tracing"
  - "openai"
canonical: "https://docs.futureagi.com/docs/cookbook/quickstart/manual-tracing"
code-repo-url: "https://github.com/future-agi/cookbooks/blob/main/quickstart/manual-tracing.ipynb"
page-type: "cookbook"
---
...
<a href="https://colab.research.google.com/github/future-agi/cookbooks/blob/main/quickstart/manual-tracing.ipynb" target="_blank" style={{display: "inline-flex"}}><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" style={{height: "28px"}} /></a>
<a href="https://github.com/future-agi/cookbooks/blob/main/quickstart/manual-tracing.ipynb" target="_blank" style={{display: "inline-flex"}}><img src="https://img.shields.io/badge/View_on_GitHub-181717?logo=github&logoColor=white" alt="GitHub" style={{height: "28px"}} /></a>
</div>
...
<Steps>
<Step title="Auto-trace every OpenAI call">
...
<img src="https://fi-cookbook-assets.s3.ap-south-1.amazonaws.com/quickstart/manual-tracing/step-2-custom-span.png" alt="Custom span tree showing answer-with-context parent with retrieve-context and OpenAI children" style={{ borderRadius: '5px' }} />
...
<img src="https://fi-cookbook-assets.s3.ap-south-1.amazonaws.com/quickstart/manual-tracing/step-4-tags.png" alt="Traces filtered by tag in the Tracing dashboard" style={{ borderRadius: '5px' }} />
...
<img src="https://fi-cookbook-assets.s3.ap-south-1.amazonaws.com/quickstart/manual-tracing/step-5-nested-spans.png" alt="Nested span tree showing rag-pipeline parent with retrieve and OpenAI children" style={{ borderRadius: '5px' }} />
...
<img src="https://fi-cookbook-assets.s3.ap-south-1.amazonaws.com/quickstart/manual-tracing/step-7-decorators.png" alt="Agent, tool, and chain spans in the trace tree" style={{ borderRadius: '5px' }} />
