---
title: "CI/CD Eval Pipeline: Automate Quality Gates on Every PR"
description: "Run automated faithfulness and toxicity eval gates on every pull request using Future AGI. Block merges when scores fall below configured thresholds."
---
