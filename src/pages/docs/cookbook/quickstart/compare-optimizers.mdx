...
<CardGroup cols={2}>
  <Card title="Open in Colab" icon="google" href="https://colab.research.google.com/github/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/compare-optimizers.ipynb">
    Run this cookbook interactively in Google Colab.
  </Card>
  <Card title="View on GitHub" icon="github" href="https://github.com/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/compare-optimizers.ipynb">
...
## Step 1: Define the dataset and baseline
...
## Step 2: Set up evaluators with different metrics
...
Any [built-in eval template](/docs/future-agi/get-started/evaluation/builtin-evals/overview) works here — the optimizer is metric-agnostic.
...
## Step 4: Run GEPA with chunk utilization metric
...
## Step 5: Run PromptWizard with completeness metric
...
<CardGroup cols={2}>
  <Card title="Prompt Optimization" icon="scale-balanced" href="/docs/cookbook/quickstart/prompt-optimization">
    Start here for MetaPrompt and Bayesian Search — the two foundational strategies.
  </Card>
  <Card title="Dataset Optimization" icon="database" href="/docs/cookbook/quickstart/dataset-optimization">
    Optimize prompts directly inside datasets using the dashboard UI.
  </Card>
  <Card title="Optimizers Overview" icon="gauge" href="/docs/future-agi/get-started/optimization/optimizers/overview">
    Full comparison of all six optimizers with architecture details.
  </Card>
  <Card title="Experimentation" icon="flask" href="/docs/cookbook/quickstart/experimentation-compare-prompts">
    A/B test optimized prompts against your baseline on a full dataset.
  </Card>
</CardGroup>
