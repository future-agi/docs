...
By the end of this guide you will have defined a voice agent with a provider endpoint, enabled observability for automatic call log import, created caller personas with voice-specific settings, generated test scenarios, run a simulation with evaluations, and used Fix My Agent to identify where the agent struggles.
...
## Step 2: Enable voice observability (optional)
...
<CardGroup cols={2}>
  <Card title="Chat Simulation with Personas" icon="comments" href="/docs/cookbook/quickstart/chat-simulation-personas">
    Test chat agents with the same persona-based approach — full SDK path included.
  </Card>
  <Card title="Tool Calling Simulation" icon="wrench" href="/docs/cookbook/quickstart/tool-calling-simulation">
    Add real tool functions to your agent and test tool invocations at scale.
  </Card>
