---
title: "Synthetic Data Generation from Column Schemas"
description: "Define column schemas with types and categorical distributions, then generate structured test datasets from the Future AGI dashboard. No code required."
---
