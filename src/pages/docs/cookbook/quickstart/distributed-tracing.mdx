---
title: "Distributed Tracing Across Services with OpenTelemetry"
description: "Propagate OpenTelemetry trace context across microservices using W3C TraceContext headers. Spans from gateway to LLM backend land in one unified trace."
---
