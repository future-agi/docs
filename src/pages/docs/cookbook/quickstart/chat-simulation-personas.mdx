---
title: "Test Your Chat Agent with Simulated Personas"
description: "Create an agent definition, build personas, generate scenarios, configure a simulation, run it via the SDK, and use Fix My Agent to diagnose failures."
---

By the end of this guide you will have created a chat agent definition, built custom personas, generated test scenarios, configured a simulation with evaluations, run it via the SDK, reviewed results, and used Fix My Agent to surface failure patterns.
...
## Step 5: Run the simulation via SDK
...
## Step 6: Review results and Fix My Agent
...
<CardGroup cols={2}>
  <Card title="Voice Simulation" icon="microphone" href="/docs/cookbook/quickstart/voice-simulation">
    Test voice agents with accent, conversation speed, and interruption settings.
  </Card>
  <Card title="Tool Calling Simulation" icon="wrench" href="/docs/cookbook/quickstart/tool-calling-simulation">
    Add real tool functions to your agent and verify they're called correctly.
  </Card>
  ...
  <Card title="Prompt Optimization" icon="scale-balanced" href="/docs/cookbook/quickstart/prompt-optimization">
    Automatically optimize your agent's prompt using evaluation-driven search.
  </Card>
</CardGroup>
