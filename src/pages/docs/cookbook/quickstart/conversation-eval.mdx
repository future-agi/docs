...
<CardGroup cols={2}>
  <Card title="Open in Colab" icon="google" href="https://colab.research.google.com/github/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/conversation-eval.ipynb">
    Run this cookbook interactively in Google Colab.
  </Card>
  <Card title="View on GitHub" icon="github" href="https://github.com/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/conversation-eval.ipynb">
...
| `customer_agent_human_escalation` | `conversation` | Pass/Fail | Failure to escalate when needed |
...
![Conversational Agent Evaluation eval group on the dashboard](/cookbook/images/conversation-eval/eval-group-dashboard.png)

<Tip>
These metrics are available as a pre-built **eval group** on the dashboard. Select the group once, map your column to `conversation`, and all metrics run together — no need to add them one by one. This is especially useful in [Simulation](/docs/cookbook/quickstart/chat-simulation-personas) workflows and when [running evals on datasets from the dashboard](/docs/cookbook/quickstart/dataset-management).
</Tip>
...
<CardGroup cols={2}>
  <Card title="Chat Simulation with Personas" icon="play" href="/docs/cookbook/quickstart/chat-simulation-personas">
    Generate multi-turn conversations automatically and evaluate them at scale.
  </Card>
  <Card title="Session Observability" icon="eye" href="/docs/cookbook/quickstart/session-observability">
    Track multi-turn conversations in production with session-based tracing.
  </Card>
  <Card title="Batch Evaluation" icon="list-check" href="/docs/cookbook/quickstart/batch-eval">
    Run conversation evals across dataset rows with pass-rate tracking.
  </Card>
  <Card title="All Built-in Metrics" icon="list" href="/docs/future-agi/get-started/evaluation/builtin-evals/overview">
    Full reference for 72+ built-in eval metrics including all conversation metrics.
  </Card>
</CardGroup>
