...
<CardGroup cols={2}>
  <Card title="Open in Colab" icon="google" href="https://colab.research.google.com/github/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/custom-eval-metrics.ipynb">
    Run this cookbook interactively in Google Colab.
  </Card>
  <Card title="View on GitHub" icon="github" href="https://github.com/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/custom-eval-metrics.ipynb">
...
<CardGroup cols={2}>
  <Card title="All Built-in Metrics" icon="list" href="/sdk-reference/evals">
    Full `evaluate()` API reference with built-in metrics and examples.
  </Card>
  <Card title="Running Your First Eval" icon="chart-line" href="/docs/cookbook/quickstart/first-eval">
    Local metrics, Turing model evals, and writing inline LLM-as-Judge rubrics.
  </Card>
  <Card title="Hallucination Detection" icon="circle-exclamation" href="/docs/cookbook/quickstart/hallucination-detection">
    Apply your eval metrics to RAG outputs: score for faithfulness and detect unsourced claims.
  </Card>
  <Card title="Eval Groups" icon="layer-group" href="/docs/future-agi/get-started/evaluation/eval-groups">
    Bundle multiple evals and run them together in one flow.
  </Card>
</CardGroup>
