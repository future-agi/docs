---
title: "Custom Eval Metrics: Build Your Own"
description: "Define LLM quality criteria in plain English, register reusable eval metrics in the FutureAGI dashboard, and run them via SDK with a single evaluate() call."
---
...
<CardGroup cols={4}>
  ...
  <Card title="Eval Groups" icon="layer-group" href="/docs/evaluation">
