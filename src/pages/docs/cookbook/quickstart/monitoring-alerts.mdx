...
By the end of this guide you will have a fully traced multi-step RAG agent generating rich performance data, explored historical latency, token, traffic, and cost trends in the Charts tab, and configured alerts with warning and critical thresholds that notify you via email or Slack when metrics cross your defined limits.

<CardGroup cols={2}>
  <Card title="Open in Colab" icon="google" href="https://colab.research.google.com/github/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/monitoring-alerts.ipynb">
    Run this cookbook interactively in Google Colab.
  </Card>
  <Card title="View on GitHub" icon="github" href="https://github.com/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/monitoring-alerts.ipynb">
...
## Step 1: Build and instrument a multi-step RAG agent
...
## Step 2: Generate trace data across multiple queries
...
## Step 3: Analyze historical trends in the Charts tab
...
<video autoPlay muted loop playsInline className="w-full rounded-xl" src="/cookbook/images/monitoring-alerts/step-3-charts-overview.mp4" />
...
<video autoPlay muted loop playsInline className="w-full rounded-xl" src="/cookbook/images/monitoring-alerts/step-4-create-alert.mp4" />
...
## Step 5: Monitor and manage alerts
...
<CardGroup cols={2}>
  <Card title="Manual Tracing" icon="eye" href="/docs/cookbook/quickstart/manual-tracing">
    Add custom spans, user context, and metadata for richer chart data and more targeted alerts.
  </Card>
  <Card title="Inline Evals in Tracing" icon="chart-line" href="/docs/cookbook/quickstart/inline-evals-tracing">
    Attach quality scores to every trace — these appear as additional charts and can trigger metric alerts.
  </Card>
  <Card title="Agent Compass" icon="compass" href="/docs/cookbook/quickstart/agent-compass-debug">
    Automatically surface failure patterns from the same trace data your alerts monitor.
  </Card>
  <Card title="Protect Guardrails" icon="shield" href="/docs/cookbook/quickstart/protect-guardrails">
    Block unsafe inputs and outputs in real time — reducing the error rates your alerts track.
  </Card>
</CardGroup>
