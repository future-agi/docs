...
By the end of this guide you will have created a saved prompt version in the Prompts workbench, launched a chat simulation against it using pre-defined scenarios, and reviewed per-conversation CSAT scores and evaluation results. All of this happens directly from the UI.
...
## Step 1: Open your prompt in the workbench
...
## Step 2: Navigate to the Simulation tab
...
## Step 4: Review and adjust the simulation configuration
...
## Step 7: Iterate — swap versions and re-run
...
<CardGroup cols={2}>
  <Card title="Chat Simulation with Personas" icon="comments" href="/docs/cookbook/quickstart/chat-simulation-personas">
    Run agent-backed simulations with distinct user personas using the full SDK path.
  </Card>
  <Card title="Prompt Versioning" icon="code-branch" href="/docs/cookbook/quickstart/prompt-versioning">
    Create and label prompt versions so you have multiple candidates to test against.
  </Card>
  ...
  <Card title="Agent Compass" icon="compass" href="/docs/cookbook/quickstart/agent-compass-debug">
    Automatically surface agent failure patterns and get fix recommendations from your traces.
  </Card>
</CardGroup>
