...
description: "Enrich datasets with AI-generated summaries, sentiment labels, entities, vector-retrieved context, and parsed JSON fields from the Future AGI dashboard."
---
...
<CardGroup cols={4}>
  ...
  <Card title="Dynamic Column Docs" icon="book" href="/docs/dataset/concepts/static-and-dynamic-columns">
