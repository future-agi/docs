...
description: "Create annotation views with categorical, numeric, and text labels, assign annotators, and log annotations programmatically using the Future AGI SDK."
---
...
<CardGroup cols={4}>
  <Card title="Annotation Docs" icon="tag" href="/docs/dataset/guides/annotate-rows">
