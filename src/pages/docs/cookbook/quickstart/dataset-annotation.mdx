...
By the end of this guide you will have created an annotation view with categorical, numeric, and text labels in the dashboard, annotated dataset rows manually and with auto-annotation, and logged annotations programmatically using the `Annotation` SDK.
...
## Step 1: Open a dataset and go to the Annotations tab
...
## Step 2: Create an annotation view and define labels
...
## Step 3: Assign annotators and annotate rows
...
## Step 4: Log annotations programmatically with the SDK
...
## Step 5: List available labels and projects
...
<CardGroup cols={2}>
  <Card title="Annotation Docs" icon="tag" href="/product/dataset/how-to/annotate-dataset">
    Full annotation feature reference with all label types and view configuration options.
  </Card>
  <Card title="Dataset Management" icon="database" href="/docs/cookbook/quickstart/dataset-management">
    Create, import, and manage datasets before annotating them.
  </Card>
  <Card title="Batch Evaluation" icon="chart-line" href="/docs/cookbook/quickstart/batch-eval">
    Run automated evals on datasets to complement human annotations.
  </Card>
  <Card title="Manual Tracing" icon="eye" href="/docs/cookbook/quickstart/manual-tracing">
    Generate traced spans that you can annotate with the SDK.
  </Card>
</CardGroup>
