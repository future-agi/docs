...
code-repo-url: "https://github.com/future-agi/cookbooks/blob/main/quickstart/instrument-and-verify-voice.ipynb"
page-type: "cookbook"
---
...
<a href="https://colab.research.google.com/github/future-agi/cookbooks/blob/main/quickstart/instrument-and-verify-voice.ipynb" target="_blank" style={{display: "inline-flex"}}><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" style={{height: "28px"}} /></a>
<a href="https://github.com/future-agi/cookbooks/blob/main/quickstart/instrument-and-verify-voice.ipynb" target="_blank" style={{display: "inline-flex"}}><img src="https://img.shields.io/badge/View_on_GitHub-181717?logo=github&logoColor=white" alt="GitHub" style={{height: "28px"}} /></a>
</div>
...
<img src="/images/docs/cookbook-instrument-and-verify-voice/call-list.png" alt="The Future AGI trace list for the voice-cookbook-page-run project, showing seven voice.call traces with input, output, timestamp, status and latency" style={{ borderRadius: '5px' }} />
