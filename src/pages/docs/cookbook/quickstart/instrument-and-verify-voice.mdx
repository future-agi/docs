...
<img src="/images/docs/cookbook-instrument-and-verify-voice/call-list.png" alt="The Future AGI trace list for the voice-cookbook-page-run project, showing eight voice.call traces with input, output, timestamp, status and latency" style={{ borderRadius: '5px' }} />
