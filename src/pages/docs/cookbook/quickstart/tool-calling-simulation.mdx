---
title: "Tool-Calling Agent Simulation & Tracing"
description: "Simulate tool-calling agent conversations, trace every tool invocation as child spans with fi-instrumentation-otel, and inspect results in the Tracing dashboard."
---
