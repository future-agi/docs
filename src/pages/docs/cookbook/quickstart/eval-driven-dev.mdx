...
description: "Build a local eval loop that scores prompts against a test suite, compares before-and-after results, and gates promotion on quality thresholds."
date: "2026-08-18"
...
tags:
  ...
  - "prompt-engineering"
  - "ci-cd"
canonical: "https://docs.futureagi.com/docs/cookbook/quickstart/eval-driven-dev"
code-repo-url: "https://github.com/future-agi/cookbooks/blob/main/quickstart/eval-driven-dev.ipynb"
page-type: "cookbook"
---
...
<a href="https://colab.research.google.com/github/future-agi/cookbooks/blob/main/quickstart/eval-driven-dev.ipynb" target="_blank" style={{display: "inline-flex"}}><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open in Colab" style={{height: "28px"}} /></a>
<a href="https://github.com/future-agi/cookbooks/blob/main/quickstart/eval-driven-dev.ipynb" target="_blank" style={{display: "inline-flex"}}><img src="https://img.shields.io/badge/View_on_GitHub-181717?logo=github&logoColor=white" alt="GitHub" style={{height: "28px"}} /></a>
</div>
...
<Step title="Score a baseline and a revised prompt">
...
<Step title="Inspect the remaining failure">
