...
description: "Use agent-opt to take a weak baseline prompt, run automated optimization, and extract the best-performing variant. No manual prompt engineering required."
---
...
<CardGroup cols={4}>
  <Card title="Optimizers Overview" icon="scale-balanced" href="/docs/optimization">
  ...
  <Card title="Using the Platform" icon="compass" href="/docs/optimization/guides/run-an-optimization">
