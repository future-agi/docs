...
<TLDR>
Run two prompt variants across multiple models on the same dataset, evaluate outputs for groundedness, and pick the winner using weighted metric comparison.
</TLDR>
