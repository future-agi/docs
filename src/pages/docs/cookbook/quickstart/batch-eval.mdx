...
By the end of this guide you will have created a dataset from a CSV, added rows programmatically, run groundedness and toxicity evaluations across every row, and downloaded the scored results.

<CardGroup cols={2}>
  <Card title="Open in Colab" icon="google" href="https://colab.research.google.com/github/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/batch-eval.ipynb">
    Run this cookbook interactively in Google Colab.
  </Card>
  <Card title="View on GitHub" icon="github" href="https://github.com/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/batch-eval.ipynb">
...
## Step 2: Create a dataset from the CSV
...
## Step 3: Add rows programmatically
...
<video autoPlay muted loop playsInline width="100%" style={{borderRadius: "8px"}}>
  <source src="/cookbook/images/batch-eval/step-4-faithfulness-output.mp4" type="video/mp4" />
</video>

## Step 5: Add a second evaluation
...
![Dataset after toxicity evaluation](/cookbook/images/batch-eval/step-5-after-toxicity.png)

## Step 6: Get evaluation statistics
...
## Step 7: Download scored results
...
## Step 8: Connect to an existing dataset
...
![Dataset after context adherence evaluation](/cookbook/images/batch-eval/step-8-after-context-adherence.png)
...
Each metric has its own required input keys for `required_keys_to_column_names`. Every metric's page in the [All Built-in Metrics](/docs/future-agi/get-started/evaluation/builtin-evals/overview) reference lists its keys.
