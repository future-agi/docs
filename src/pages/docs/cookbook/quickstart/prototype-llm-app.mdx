...
By the end of this guide you will have registered a prototype project with automatic span evaluation, run an OpenAI app against it, iterated with a second prompt version, compared both versions in the Prototype dashboard, and chosen a winner.

<CardGroup cols={2}>
  <Card title="Open in Colab" icon="google" href="https://colab.research.google.com/github/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/prototype-llm-app.ipynb">
    Run this cookbook interactively in Google Colab.
  </Card>
  <Card title="View on GitHub" icon="github" href="https://github.com/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/prototype-llm-app.ipynb">
...
<CardGroup cols={2}>
  <Card title="Prototype Overview" icon="flask" href="/docs/future-agi/get-started/prototype/overview">
    Full Prototype documentation — project types, eval tags, and version management.
  </Card>
  <Card title="Prototype Evals Reference" icon="chart-line" href="/docs/future-agi/get-started/prototype/evals">
    All available EvalTag configurations, mapping attributes, and supported eval metrics.
  </Card>
  <Card title="Compare Prompts in Experiments" icon="code-branch" href="/docs/cookbook/quickstart/experimentation-compare-prompts">
    Dataset-level prompt comparison with the Experiment feature — a UI-first alternative to Prototype.
  </Card>
  <Card title="Manual Tracing" icon="eye" href="/docs/cookbook/quickstart/manual-tracing">
    Add custom spans, user context, and metadata to any traced application.
  </Card>
</CardGroup>
