...
By the end of this guide you will have a traced application where every LLM call is automatically scored for quality - and those scores appear as attributes on the span, searchable and filterable in the FutureAGI Tracing dashboard.

<CardGroup cols={2}>
  <Card title="Open in Colab" icon="google" href="https://colab.research.google.com/github/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/inline-evals-tracing.ipynb">
    Run this cookbook interactively in Google Colab.
  </Card>
  <Card title="View on GitHub" icon="github" href="https://github.com/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/inline-evals-tracing.ipynb">
...
## Step 1: Set up tracing and the Evaluator
...
## Step 2: Attach an eval to a span with `trace_eval=True`
...
<video
  ...
  src="/cookbook/images/inline-evals-tracing/step-2-attach-eval-to-span.mp4"
/>

---

## Step 3: Run multiple evals on the same span
...
## Step 4: Inline evals on a full RAG pipeline
...
<img src="/cookbook/images/inline-evals-tracing/step-3-multiple-evals.png" alt="Multiple evals attached to a single span" />

---

## Step 5: View and filter by eval scores in the dashboard
...
<img src="/cookbook/images/inline-evals-tracing/step-4-rag-pipeline.png" alt="RAG pipeline trace with inline groundedness eval" />
...
<CardGroup cols={2}>
  <Card title="Manual Tracing" icon="eye" href="/docs/cookbook/quickstart/manual-tracing">
    Add custom spans, attributes, and context managers to any application.
  </Card>
  <Card title="Running Your First Eval" icon="chart-line" href="/docs/cookbook/quickstart/first-eval">
    All built-in metrics and how to use the evaluate() function directly.
  </Card>
  <Card title="Agent Compass" icon="compass" href="/docs/cookbook/quickstart/agent-compass-debug">
    Use trace data to automatically surface failure patterns and get fix recommendations.
  </Card>
  <Card title="Session-Based Observability" icon="users" href="/docs/cookbook/quickstart/session-observability">
    Add user and session context to traces for grouped multi-turn conversation analysis.
  </Card>
</CardGroup>
