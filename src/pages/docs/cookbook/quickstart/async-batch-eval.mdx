...
By the end of this guide you will have submitted async evaluations that return immediately, polled for results with `get_eval_result()`, and evaluated 50+ items in parallel with progress tracking.

<CardGroup cols={2}>
  <Card title="Open in Colab" icon="google" href="https://colab.research.google.com/github/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/async-batch-eval.ipynb">
    Run this cookbook interactively in Google Colab.
  </Card>
  <Card title="View on GitHub" icon="github" href="https://github.com/future-agi/cookbooks/blob/cookbook/quickstart-notebooks/quickstart/async-batch-eval.ipynb">
...
## Step 1: Run a synchronous eval as a baseline
...
## Step 2: Submit an async evaluation (fire and forget)
...
## Step 3: Poll for results with `get_eval_result()`
...
## Step 4: Evaluate 50+ items in parallel
...
## Step 5: Parallel async submissions with batch polling
...
<CardGroup cols={2}>
  <Card title="Running Your First Eval" icon="flask" href="/docs/cookbook/quickstart/first-eval">
    Local metrics, Turing models, and LLM-as-Judge for single responses.
  </Card>
  <Card title="Dataset SDK: Batch Evaluation" icon="table" href="/docs/cookbook/quickstart/batch-eval">
    Upload a CSV and run server-side batch evals across every row.
  </Card>
  <Card title="CI/CD Eval Pipeline" icon="github" href="/docs/cookbook/quickstart/cicd-eval-pipeline">
    Block bad prompts from shipping with automated eval gates.
  </Card>
