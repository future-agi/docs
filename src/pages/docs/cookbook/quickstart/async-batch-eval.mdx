---
title: "Async & Batch Evaluations at Scale"
description: "Submit fire-and-forget async evaluations, poll job IDs for results, and run 50+ evals in parallel with ThreadPoolExecutor using the FutureAGI Evaluator SDK."
---
