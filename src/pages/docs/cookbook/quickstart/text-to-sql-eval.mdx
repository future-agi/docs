---
title: "Text-to-SQL LLM Evaluation with Future AGI"
description: "Evaluate LLM-generated SQL queries with string comparison, execution-based validation against a live database, and built-in text_to_sql eval metrics."
---
