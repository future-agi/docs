---
title: "Importing Hugging Face Datasets into Future AGI"
description: "Import any public Hugging Face dataset into Future AGI with a single SDK call, run evaluations, and download scored results."
---
