...
## Step 1: Create a dataset with a Run Prompt column
...
## Step 2: Open the Optimization tab
...
## Step 3: Configure and launch an optimization run
...
## Step 4: Monitor the optimization run
...
## Step 5: Review trial results and compare prompts
...
<CardGroup cols={2}>
  <Card title="Compare Optimization Strategies" icon="scale-balanced" href="/docs/cookbook/quickstart/compare-optimizers">
    Run ProTeGi, GEPA, and PromptWizard programmatically via SDK and compare results.
  </Card>
  <Card title="Prompt Optimization" icon="gauge" href="/docs/cookbook/quickstart/prompt-optimization">
    Start with MetaPrompt and Bayesian Search — the two foundational strategies.
  </Card>
  <Card title="Dynamic Dataset Columns" icon="table-columns" href="/docs/cookbook/quickstart/dynamic-dataset-columns">
    Create Run Prompt columns and other dynamic column types in your dataset.
  </Card>
  <Card title="Prompt Versioning" icon="code-branch" href="/docs/cookbook/quickstart/prompt-versioning">
    Save the winning prompt with version control and serve it in production.
  </Card>
</CardGroup>
