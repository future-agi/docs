...
By the end of this guide you will have built a RAG test suite with ground-truth answers, imported additional test cases from CSV, and scored every response for groundedness; all from the dashboard.
...
## Step 4: Import more rows from CSV
...
## Step 5: Run evals on the dataset
...
<CardGroup cols={2}>
  ...
  <Card title="Dataset Overview" icon="book" href="/product/dataset/overview">
    Full reference for dataset features, column types, and workflows.
  </Card>
</CardGroup>
