---
title: "LangChain and LangGraph Observability with Future AGI"
description: "Add observability and evaluation to LangChain and LangGraph agents using Future AGI tracing. Detect completeness, groundedness, and hallucinations."
---
