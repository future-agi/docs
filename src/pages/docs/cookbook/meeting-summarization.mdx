...
Loading a dataset in the Future AGI platform is easy. You can either directly upload it as JSON or CSV, or you could import it from Hugging Face. Follow detailed steps on how to add a dataset to Future AGI in the [docs](/docs/products/dataset/overview).

![Image 1](/images/docs/cookbook-meeting-summarization/c11.png)
![Image 2](/images/docs/cookbook-meeting-summarization/c12.png)
...
![Image 3](/images/docs/cookbook-meeting-summarization/c13.png)
![Image 4](/images/docs/cookbook-meeting-summarization/c14.png)
![Image 5](/images/docs/cookbook-meeting-summarization/c15.png)
