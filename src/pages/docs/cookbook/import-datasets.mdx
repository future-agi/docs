---
title: "Using Custom Datasets for Prompt Optimization in agent-opt"
description: "Prepare and integrate datasets from in-memory, CSV, JSON, and JSONL sources for prompt optimization with the agent-opt library."
---
