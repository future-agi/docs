---
title: "Basic Prompt Optimization with the agent-opt Library"
description: "Optimize your first prompt using the agent-opt Python library with RandomSearchOptimizer. Generate prompt variations and select the best performer."
---
