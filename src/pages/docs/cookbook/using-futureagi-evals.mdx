---
title: "Evaluating AI Models with the Future AGI Evaluator SDK"
description: "Evaluate AI model outputs using the ai-evaluation package. Choose built-in templates, pass inputs, and receive scored results with the Evaluator class."
---
