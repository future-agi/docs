---
title: "LLM Observability with a LangChain Chatbot and Future AGI"
description: "Instrument a LangChain chatbot with Future AGI tracing to monitor LLM performance, track metrics, and improve application stability."
---
