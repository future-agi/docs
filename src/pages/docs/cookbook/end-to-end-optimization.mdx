---
title: "End-to-End Prompt Optimization with Future AGI Evaluation"
...
Yes, by using prompt SDK, the output can be stored as a new template version and managed like any other prompt artifact. Click [here](/docs/prompt/reference/sdk-api) to learn more.
