...
<Note>
We are using one of Future AGI's builtin eval called `summary_quality`. Click [here](https://docs.futureagi.com/docs/evaluation/builtin/overview) to learn what other builtin evals Future AGI offers.
</Note>
...
No. Future AGI provides 60+ [built-in](http://docs.futureagi.com/docs/evaluation/builtin/overview) evaluators and supports LLM-as-a-Judge patterns out of the box. Evaluation execution, scoring, and aggregation are handled by the platform.
