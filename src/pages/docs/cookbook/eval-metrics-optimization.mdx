---
title: "Choosing Evaluation Metrics for Prompt Optimization"
description: "Compare three methods for evaluating prompt quality within agent-opt: the Future AGI platform, local LLM-as-a-judge, and local heuristic metrics."
---
...
<CardGroup cols={2}>
  ...
  <Card 
    ...
    icon="code" 
    href="/docs/optimization/guides/optimize-from-the-sdk"
  >
