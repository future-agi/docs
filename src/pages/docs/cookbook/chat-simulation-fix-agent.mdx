---
title: "AI Chat Agent Simulation and Fix My Agent Diagnostics"
description: "Simulate AI chat agents across multiple scenarios, analyze performance metrics, and use Fix My Agent for AI-powered diagnostics."
---
...
Navigate to the [Prompt Workbench](https://app.futureagi.com/dashboard/workbench) and:
