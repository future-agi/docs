...
description: "Manage organizations, members, and org-level settings in Command Center."
---

## About

Each Command Center organization is an isolated environment with its own providers, routing rules, rate limits, budgets, and API keys. Organizations are the top-level unit for multi-tenancy in Command Center.
