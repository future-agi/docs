---
title: "Self-Hosted Command Center"
description: "Deploy Agent Command Center on your own infrastructure via Docker or Go binary — full control over data residency, routing, failover, caching, and rate limiting."
---
