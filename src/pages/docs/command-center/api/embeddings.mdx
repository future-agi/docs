---
title: "Embeddings & Reranking API"
description: "Generate text embeddings and rerank documents via Agent Command Center. OpenAI-compatible format with caching, cost tracking, failover, and rate limiting."
---
