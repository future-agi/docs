...
description: "Generate text embeddings and rerank documents through the Command Center Gateway."
---
...
<Tabs items={["Command Center SDK", "OpenAI SDK", "LiteLLM", "cURL"]}>
...
<Tabs items={["Command Center SDK", "cURL"]}>
