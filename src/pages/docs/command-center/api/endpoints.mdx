...
description: "Complete list of all API endpoints available through the Command Center Gateway."
---

## About

Command Center exposes 97 endpoints across 20+ categories. All inference endpoints live under `/v1/` and follow the OpenAI API format. Admin endpoints live under `/-/` and require an admin token.

## Base URL

All endpoints are relative to your Command Center gateway URL:
...
Command Center acts as an MCP server, aggregating tools from upstream MCP tool servers.
