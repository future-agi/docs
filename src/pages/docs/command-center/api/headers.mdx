...
description: "Reference for all x-agentcc-* headers in Agent Command Center — control caching, sessions, and routing per request; read cost, latency, and provider in responses."
---
