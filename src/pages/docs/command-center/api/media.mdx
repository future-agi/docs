...
description: "Text-to-speech, speech-to-text, audio translation, and image generation through the Command Center Gateway."
---

## About

Command Center proxies audio and image requests to any configured provider. The API follows the OpenAI format. All gateway features (caching, rate limiting, cost tracking, failover) apply to these endpoints.
...
audio_bytes = client.audio.speech.create(
    model="tts-1",
    voice="alloy",
    input="Hello! This is a test of text-to-speech through Command Center.",
)
