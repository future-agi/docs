---
title: "Media Endpoints: Audio & Image"
description: "Text-to-speech, speech-to-text, audio translation, and image generation via Agent Command Center with caching, cost tracking, and provider failover."
---
