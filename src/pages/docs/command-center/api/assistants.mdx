---
title: "Assistants API via Command Center"
description: "Proxy the OpenAI Assistants API through Agent Command Center with routing, cost tracking, and logging for threads, runs, and tool use."
---
