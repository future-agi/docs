...
description: "POST /v1/chat/completions through Agent Command Center — OpenAI-compatible with routing, caching, guardrails, streaming, function calling, and vision."
---
