---
title: "Command Center API Reference"
description: "Complete API reference for Agent Command Center — OpenAI-compatible endpoints, x-agentcc-* request headers, and response headers with routing and cost metadata."
---
