...
description: "Manage sk-agentcc-* virtual keys in Agent Command Center — restrict models, providers, and IPs with RBAC roles and enforce per-key rate limits and budgets."
---
...
Go to **Gateway > API Keys** in the Future AGI dashboard to create, view, and revoke keys.
