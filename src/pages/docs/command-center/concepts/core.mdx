...
description: "How Agent Command Center works — request pipeline, plugin execution order, virtual keys, per-org multi-tenancy, caching, guardrails, and cost tracking."
---
