---
title: "MCP and A2A Protocol Support in Agent Command Center"
description: "Connect AI agents via MCP (Model Context Protocol) and A2A (Agent-to-Agent) to aggregate tools, delegate tasks, and build multi-agent networks."
---
