---
title: "Streaming"
description: "Use Server-Sent Events (SSE) streaming with Command Center for real-time LLM responses."
---
...
<Steps>
  <Step title="Enable streaming in your request">
    Set `"stream": true` in your request payload to the Command Center gateway.
  </Step>
...
Command Center translates streaming from all providers to the standard OpenAI SSE format:
