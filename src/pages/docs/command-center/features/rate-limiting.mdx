...
Command Center supports rate limits at three levels: global, per-org, and per-key.
...
Go to **Command Center > Rate Limits** in the Future AGI dashboard to set global and per-org limits.
...
Go to **Command Center > Budgets** in the Future AGI dashboard to set org-level budgets and alerts.
