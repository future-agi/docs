---
title: "Rate Limiting and Budget Controls in Agent Command Center"
description: "Set per-key, per-org, and global RPM limits. Enforce monthly spend budgets and per-key credit balances to prevent runaway costs and protect provider quotas."
---
...
Per-key limits are set when creating or editing a key in **Gateway > API Keys**.
