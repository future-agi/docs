...
Command Center is Future AGI's AI Gateway. It sits between your application and LLM providers, giving you a single API that handles routing across 100+ providers, safety guardrails, response caching, cost tracking, and full observability.
...
<AccordionGroup>
  ...
  <Accordion title="Can I self-host Command Center?">
    Yes. Command Center is distributed as a Go binary and Docker image. See the <a href="/docs/command-center/deployment/self-hosted">Self-Hosted Deployment</a> guide.
  </Accordion>
</AccordionGroup>
