...
description: "Connect your application to Future AGI by registering a tracer provider and adding instrumentation — either via auto-instrumentors or manual OpenTelemetry spans."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Instrument with TraceAI" icon="plug" href="/docs/tracing/manual/instrument-with-traceai-helpers">
