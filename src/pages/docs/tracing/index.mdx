...
- That data powers the UI—trace list, span detail, [sessions](/docs/observe/features/session), [evals](/docs/observe/features/evals), and [alerts](/docs/observe/features/alerts) all run on top of traced data.
- The platform uses this pipeline in two ways:
  ...
  - **[Observe](/docs/observe)** — Monitor production with traces, evals, and alerts.
...
- **Evals and alerts** — [Evaluations](/docs/observe/features/evals) and [alerts](/docs/observe/features/alerts) run on observation spans; tracing is what fills those spans.
- **Sessions and users** — When spans carry [session.id](/docs/observe/features/session) or [user.id](/docs/observe/features/users), traces are grouped into sessions and end users in the UI.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="rocket"
    href="/docs/observe/features/quickstart"
  >
  ...
  <Card
    ...
    icon="eye"
    href="/docs/tracing/concepts/traces"
  >
  ...
  <Card
    ...
    icon="code"
    href="/docs/tracing/concepts/otel"
  >
