...
- That data powers the UI—trace list, span detail, [sessions](/docs/observe/session), [evals](/docs/observe/evals), and [alerts](/docs/observe/alerts-and-monitors) all run on top of traced data.
- The platform uses this pipeline in two ways:
  - **[Prototype](/docs/prototype/overview)** — Test and compare LLM configurations before production; promote a winner.
  - **[Observe](/docs/observe/overview)** — Monitor production with traces, evals, and alerts.
...
- **Evals and alerts** — [Evaluations](/docs/observe/evals) and [alerts](/docs/observe/alerts-and-monitors) run on observation spans; tracing is what fills those spans.
- **Sessions and users** — When spans carry [session.id](/docs/observe/session) or [user.id](/docs/observe/users), traces are grouped into sessions and end users in the UI.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="rocket"
    href="/docs/observe/set-up-observability"
  >
  ...
  <Card
    ...
    href="/docs/tracing/auto/overview"
  >
