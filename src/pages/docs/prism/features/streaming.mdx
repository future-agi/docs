...
![Blocking request flow — client waits for complete response](/screenshot/product/prism/blocking-flow.png)
...
![Streaming request flow — client receives tokens incrementally](/screenshot/product/prism/streaming-flow.png)
