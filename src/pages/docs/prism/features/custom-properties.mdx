...
Pass custom property values as metadata on your request. Pass custom property values in the x-prism-metadata header (OpenAI SDK / cURL) or the requestMetadata option (TypeScript SDK).
<Tabs items={["Python (OpenAI SDK)", "TypeScript", "cURL"]}>
