...
<Note>
Routing and failover do not apply to the Assistants API because threads and runs are stored on OpenAI's servers. The assistant's model must be an OpenAI model.
</Note>
