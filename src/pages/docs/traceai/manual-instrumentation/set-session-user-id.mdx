...
geo:
  direct_answer: true
related:
  concept: "/docs/observe/concepts/sessions"
...
- The trace appears in the [Sessions](/docs/observe/features/session) view under your `session.id`, and under the user in the [Users](/docs/observe/concepts/users) view.
