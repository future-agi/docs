...
<img src="/images/docs/agent-playground/guides/build-workflow/set-input-variables.png" alt="The Variables drawer open over the builder canvas, listing eight prompt variables in double braces, each with its value filled in below the name" style={{ borderRadius: '5px' }} />
