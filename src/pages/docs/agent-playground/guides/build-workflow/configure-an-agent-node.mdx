...
<Note>
This guide picks up once a workflow with an Agent Node already exists on the canvas; see [Build an AI Agent Workflow](/docs/agent-playground/features/build-workflow) to add one first.
</Note>
