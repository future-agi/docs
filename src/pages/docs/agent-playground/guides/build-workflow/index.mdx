...
description: "A tour of the Agent Builder canvas: adding nodes, wiring connections, deleting nodes, and saving what you've built."
---
...
<img src="/images/docs/agent-playground/node-connection-handles.png" alt="An output handle connected by a dashed line to an input handle on the next node" style={{ borderRadius: '5px' }} />
...
- A connection that would wire a node back into its own upstream path draws and saves like any other, but it isn't caught until you click **Save Agent** or **Run**, when the builder toasts "Graph contains a cycle. Remove the circular connection before saving."
