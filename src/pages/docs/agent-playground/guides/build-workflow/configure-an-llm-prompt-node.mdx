...
<img src="/images/docs/agent-playground/guides/build-workflow/configure-an-llm-prompt-node.png" alt="The LLM Prompt node drawer open beside the canvas, with Prompt Name filled in, the version select and Draft badge beside it, Select Model below, and the System and User message boxes under that" style={{ borderRadius: '5px' }} />
