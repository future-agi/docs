...
<Note>
This guide picks up once a workflow with an LLM Prompt node already exists on the canvas; see [Build an AI Agent Workflow](/docs/agent-playground/features/build-workflow) to add one first.
</Note>
