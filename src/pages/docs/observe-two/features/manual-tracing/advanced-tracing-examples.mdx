...
<CardGroup cols={2}>
  ...
  <Card title="Add Events & Exceptions" icon="lightning" href="/docs/observe-two/features/manual-tracing/add-events-exceptions-status">
    Record exceptions and set span status for error visibility.
  </Card>
  <Card title="Get Current Span" icon="magnifying-glass" href="/docs/observe-two/features/manual-tracing/get-current-span-context">
