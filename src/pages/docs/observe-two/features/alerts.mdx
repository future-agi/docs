...
<img src="/images/docs/observe-two/alerts-overview.png" alt="Alerts list — Issues, Status, Alert Type, Last Triggered, No. of triggers, Updated at" style={{ borderRadius: '5px' }} />
...
<img src="/images/docs/observe-two/alerts-create.png" alt="Choose a project dialog when creating a new alert" style={{ borderRadius: '5px' }} />
