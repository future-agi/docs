...
*   You can add documents via the UI or using the SDK. See [Create KB using UI](/product/knowledge-base/how-to/create-kb-using-ui) and [Create KB using SDK](/product/knowledge-base/how-to/create-kb-using-sdk).

**What file types are supported?**

*   PDF, DOCX, TXT, RTF, CSV, JSON, and more. Refer to the [Knowledge Base Concepts](/product/knowledge-base/overview).
...
*   Prototyping helps you iterate quickly on different versions of your AI application or prompt. See the [Prototype Overview](/product/prototype/overview).

**How do I choose a winning prototype?**

*   You can compare prototypes based on evaluations and select the best performing one. See [Choose Winner](/product/prototype/features//winner).

## Observe

**What can I monitor with Observe?**

*   Observe helps monitor key metrics like latency, cost, token usage, and evaluation results over time. See the [Observe Overview](/product/observe/quickstart).

**How do I set up alerts?**

*   Alerts can be configured to notify you about anomalies or issues based on defined thresholds. See [Alerts and Monitors](/product/observe/evals).
