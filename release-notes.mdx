...
<Update label="Week of 05-09-2025">
  ...
  **Features**
  - **Add Annotation Summary Page in Dataset:** Introduced a comprehensive summary page that provides insights into the annotation process. The page displays agreement levels between annotators, average annotation time per annotator, estimated completion time, and quality metrics such as cosine similarity, Pearson correlation, and Fleiss’ kappa.  
