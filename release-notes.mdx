...
<Update label="Week of 2025-08-19">
  ...
  **Features**
  ...
  - Users page in dashboard and observe: Searchable, filterable user list and detailed user view with metrics, interactive charts, synced time filters, and traces/sessions tabs.
  - Displaying the time stamp column in trace/spans: Added Start Time and End Time columns in Observe → LLM Tracing and Prototype → All runs → Run details.
  ...
  **Bugs/Improvements**
  ...
  - Fixing the editable issue in custom evals form: Incorrect config was displayed on evals page for function evals.
