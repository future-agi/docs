...
<CardGroup>
  <Card title="Evaluation" icon="chart-mixed" href="/future-agi//get-started/evaluation/">
  ...
  <Card title="Prompt Workbench" icon="wand-magic-sparkles" href="/future-agi/get-started/prompt-workbench/overview">
  ...
  <Card title="MCP" icon="plug" href="/future-agi/get-started/mcp/mcp-server">
    Connect your development environment to Future AGI features using the Model Context Protocol.
  </Card>
  
  <Card title="Admin & Settings" icon="gear" href="/future-agi/get-started/api-keys">
