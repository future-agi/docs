...
[Click here to read the eval definition of One Line](/future-agi/get-started/evaluation/builtin-evals/length-evals#1-one-line)
...
[Click here to read the eval definition of Length Less Than](/future-agi/get-started/evaluation/builtin-evals/length-evals#2-length-less-than)
...
[Click here to read the eval definition of Length Greater Than](/future-agi/get-started/evaluation/builtin-evals/length-evals#3-length-greater-than)
...
[Click here to read the eval definition of Length Between](/future-agi/get-started/evaluation/builtin-evals/length-evals#4-length-between)
...
[Click here to read the eval definition of Contains](/future-agi/get-started/evaluation/builtin-evals/contain-evals#1-contains)
...
[Click here to read the eval definition of Contains Any](/future-agi/get-started/evaluation/builtin-evals/contain-evals#2-contains-any)
...
[Click here to read the eval definition of Contains All](/future-agi/get-started/evaluation/builtin-evals/contain-evals#3-contains-all)
...
[Click here to read the eval definition of Contains None](/future-agi/get-started/evaluation/builtin-evals/contain-evals#4-contains-none)
...
[Click here to read the eval definition of Starts With](/future-agi/get-started/evaluation/builtin-evals/contain-evals#5-starts-with)
...
[Click here to read the eval definition of Ends With](/future-agi/get-started/evaluation/builtin-evals/contain-evals#6-ends-with)
...
[Click here to read the eval definition of Equals](/future-agi/get-started/evaluation/builtin-evals/contain-evals#7-equals)
...
[Click here to read the eval definition of Regex](/future-agi/get-started/evaluation/builtin-evals/regex)
