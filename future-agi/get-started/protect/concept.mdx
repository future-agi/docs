...
Protect is a real-time guardrail that screens every model input and output in your GenAI application—blocking or flagging unsafe, biased, or non-compliant content before it reaches users.

## **How does it work?**

Protect works by screening every model input and output in your GenAI application—blocking or flagging unsafe, biased, or non-compliant content before it reaches users.
it can be easily integrated with your existing application by using the Future AGI SDK.

## **Modes Of Protect**

- **Protect-Flash**: Very Fast and lightweight mode to protect the input and output of the model, it covers most of the basic safety metrics like hate speech, profanity, and more.
- **Protect**: This mode is used to protect the input and output of the model, it covers the descriptive safety metrics like toxicity, data privacy, and more.
