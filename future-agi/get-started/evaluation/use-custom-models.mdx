...
<Tip>
Learn how to define eval rules that use your model: [Create custom evals](/product/evaluation/how-to/create-custom-eval).
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Use Future AGI models" icon="robot" href="/product/evaluation/use-future-agi-models">
    Compare built-in evaluation models.
  </Card>
