...
- [**Evaluate Function Calling**](/future-agi/get-started/evaluation/builtin-evals/evaluate-function-calling): Text to SQL evaluates SQL generation specifically, whereas Evaluate Function Calling assesses the correctness of function calls and parameters more broadly.
