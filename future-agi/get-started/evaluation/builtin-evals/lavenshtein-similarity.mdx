...
- [**BLEU Score**](/future-agi/get-started/evaluation/builtin-evals/bleu-score): Levenshtein operates at character level, while BLEU focuses on n-gram precision between the candidate and reference texts.