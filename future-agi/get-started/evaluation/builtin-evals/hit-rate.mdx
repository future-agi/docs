...
- [**Recall@K**](/future-agi/get-started/evaluation/builtin-evals/recall-at-k): Hit Rate only checks if any relevant chunk was found, while Recall@K measures the fraction of all relevant chunks that were retrieved.
- [**MRR**](/future-agi/get-started/evaluation/builtin-evals/mrr): Hit Rate is binary (hit or miss), while MRR additionally measures how high the first relevant chunk ranks.
- [**Precision@K**](/future-agi/get-started/evaluation/builtin-evals/precision-at-k): Hit Rate checks for the existence of any relevant result, while Precision@K measures what fraction of all retrieved results are relevant.
