...
- [**Recall@K**](/future-agi/get-started/evaluation/builtin-evals/recall-at-k): Precision@K measures retrieval quality (how clean the results are), while Recall@K measures retrieval coverage (how many relevant items were found). Optimizing one often trades off against the other.
- [**NDCG@K**](/future-agi/get-started/evaluation/builtin-evals/ndcg-at-k): NDCG@K considers both relevance and ranking position, while Precision@K treats all positions equally within the top K.
- [**Chunk Utilization**](/future-agi/get-started/evaluation/builtin-evals/chunk-utilization): Precision@K evaluates retrieval quality before generation, while Chunk Utilization measures how well the generator actually uses the retrieved chunks.
