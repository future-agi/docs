...
![No Scenarios Empty State](./images/16.png)
...
![Select Evaluations Screen](./images/21.png)
...
![Add Evaluations Empty State](./images/23.png)

**Evaluation Selection Dialog**
Clicking "Add Evaluations" opens a comprehensive dialog:

![Evaluation Selection Dialog](./images/24.png)
...
![Selected Evaluations List](./images/25.png)
...
![Evaluation Mapping](./images/26.png)
