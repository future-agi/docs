---
title: "Scenarios"
description: "Creating and managing test scenarios for your AI agent simulations with automatic generation capabilities"
---
...
Scenarios are the foundation of effective agent testing. They define the test cases, customer profiles, and conversation flows that your AI agent will encounter during simulations. 

FutureAGI offers both manual and automatic scenario generation capabilities, making it easy to create comprehensive test suites for any use case. A scenario is a structured test case that simulates real-world interactions your agent will face. Each scenario includes:
