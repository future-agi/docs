---
title: "Overview"
description: "An introduction to Agent optimization with the agent-opt Python library."
---

**Prompt Optimization** provides a structured, iterative approach to refining AI-generated outputs by systematically improving prompts. With the `agent-opt` Python library, you can programmatically enhance your prompts by adjusting their structure based on evaluation-driven feedback.
