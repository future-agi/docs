---
title: "User Tab"
description: "The User Tab provides a consolidated view of all interactions, sessions, and traces linked to a specific user. It enables LLM application developers to debug issues, analyze behavior patterns, and optimize resource allocation at the individual user level."
---
...
Supported identifier types: `email`, `uuid`, `phone`, `custom`.
