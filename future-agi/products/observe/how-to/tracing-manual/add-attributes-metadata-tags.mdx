...
To avoid naming conflicts with [semantic conventions](/future-agi/products/observe/how-to/tracing-manual/semantic-conventions), it's recommended to prefix your custom attributes with your company name (e.g., mycompany.).
...
This context manager enriches the current OpenTelemetry Context with metadata. Our auto-instrumentators will apply this metadata as span attributes following traceAI [semantic conventions](/future-agi/products/observe/how-to/tracing-manual/semantic-conventions). The metadata must be provided as a string-keyed dictionary, which will be JSON-serialized in the context.
