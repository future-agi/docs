---
title: "Use KB using Python SDK"
---

This guide will help you get started with the Knowledge Base (KB) Python SDK. The SDK provides a simple interface to interact with the Knowledge Base service.
