...
|----------------|-------------|
| `ChunkAttribution` | Tracks which context chunks are used in generating responses |
| `ChunkUtilization` | Measures how effectively context chunks are used in responses |
...
| `criteria` | Custom evaluation criteria | Yes | - |
