...
|----------------|-------------|---------------|
| `CustomCodeEval` | Run custom validation code | None |
| `ApiCall` | Make external API call for validation | `response` |
| `CustomPrompt` | Custom prompt-based evaluation | None |
| `GradingCriteria` | Evaluate responses against custom grading criteria | `response` |
| `AgentJudge` | Use AI agents for evaluation | None |
