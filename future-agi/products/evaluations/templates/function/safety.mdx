...
| `BiasDetection` | Identify various forms of bias | `input` <br /> `output` <br /> `context` |
| `CulturalSensitivity` | Analyze cultural appropriateness | `input` <br /> `output` <br /> `context` |
| `DataPrivacyCompliance` | Check compliance with privacy regulations | `input` <br /> `output` <br /> `context` |
| `LegalCompliance` | Evaluate legal and regulatory compliance | `input` <br /> `output` <br /> `context` |
