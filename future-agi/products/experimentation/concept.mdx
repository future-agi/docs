...
<a href="/future-agi/products/dataset/create-dynamic-column/using-run-prompt" style={{ color: "rgb(207, 107, 232)", textDecoration: "none", fontStyle: "italic" }}>Click here to read more about prompt configuration</a>
...
> 
<a href="/future-agi/products/evaluation/eval-definition" style={{ color: "rgb(207, 107, 232)", textDecoration: "none", fontStyle: "italic" }}>Click here to read more about evaluation criteria</a>
