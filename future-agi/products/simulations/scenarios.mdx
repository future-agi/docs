...
- Specify parameters:
  ...
  - Objection patterns to generate
   <Tip>
   Click [here](https://docs.futureagi.com/future-agi/products/dataset/create-synthetic-data) to learn how to create synthetic datasets.
   </Tip>
...
![Graph Scenario Builder](images/27.png)
![Graph Scenario Builder](images/28.png)
