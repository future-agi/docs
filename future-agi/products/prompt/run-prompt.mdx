...
## 2. Select Run Prompt
You can view your dataset in a spreadsheet like interface. On the top righ corner, select **Run Prompt** option to create prompt.
![Step 2](./images/2.png)
...
## 5. Running Prompt
After creating prompt and choosing model parameters you can click on **Save and Run** and it will save this prompt configuration and start the test.
![Step 9](./images/9.png)

Prompt responses can be seen as a separate column to the dataset with prompt name as the column name. 
