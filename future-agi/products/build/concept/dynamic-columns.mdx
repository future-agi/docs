...
<a href="/future-agi/products/build/how-to/dynamic-column/using-run-prompt" style={{ color: "rgb(207, 107, 232)", textDecoration: "none", fontStyle: "italic" }}>Click here to learn how to create dynamic columns</a>
