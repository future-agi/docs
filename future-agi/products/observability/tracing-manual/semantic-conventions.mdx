...
- Python: [FI Python Semantic Conventions]()
- TypeScript: [FI TypeScript Semantic Conventions]()
...
<Tabs>
  ...
  <Tab title="TypeScript Usage">
    ```typescript
    import { SemanticConventions, FISpanKind } from './semantic-conventions';
...
<Tabs>
  ...
  <Tab title="TypeScript Example">
    ```typescript
    import { MessageConventions } from './semantic-conventions';
