  ...
  "records": [
    {
      ...
      "notes": [
        {
          "text": "First note 2024-07-09T12:34:56Z",
          "annotator_id": "human_annotator_1"
        }
      ]
    },

    /* An update to the same span */
    {
      "observation_span_id": "",
      "annotations": [
        {
          "annotation_label_id": "lbl_123",
          "annotator_id": "human_annotator_1",
          "value": "good-updated"                    // overwrites previous value
        }
      ],
      "notes": [
        {
          "text": "First note 2024-07-09T12:34:56Z", // duplicate → ignored
          "annotator_id": "human_annotator_1"
        },
        {
          "text": "Second, fresh note 2024-07-09T12:34:56Z",
          "annotator_id": "human_annotator_1"
        }
      ]
    }
...
BASE_URL      = "https://api.futureagi.com"
USE_API_KEY   = True                      # False → use JWT
...
def headers():
    return (
        ...
        if USE_API_KEY
        else {"Authorization": f"Bearer {JWT_TOKEN}", "Content-Type": "application/json"}
    )
