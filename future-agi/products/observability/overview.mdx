...
1. **Prototype:** Prototype your LLM application to find the best fit for your use case before deploying in production. [Learn More ->](/future-agi/products/prototype/overview)
...
<CardGroup>
  <Card 
    title="Prototype" 
    icon="flask" 
    href="/future-agi/products/prototype/overview"
  >
