...
* **[Insights](#insights):** Insights are high level overview of the complete trace execution. They do not change with the currently active [taxonomy metric](/future-agi/products/observability/agent-compass/taxonomy) and give a bird's eye view of what your agent did during execution
...
* **[Root Causes](#root-causes):** Identifies the root cause of an error occurence
