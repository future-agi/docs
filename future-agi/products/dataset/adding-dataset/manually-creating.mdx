...
- **[Static Columns](/future-agi/products/dataset/create-static-column)**: Stores fixed values directly within a dataset.
- **[Dynamic Columns](/future-agi/products/dataset/create-dynamic-column)**: Generates values automatically and dynamically based on a defined criteria.
