...
- [Run prompts](/future-agi/products/prompt/run-prompt) on your dataset
- [Create experiments](/future-agi/products/experiment/experiment) to test different configurations
- [Evaluate results](/future-agi/products/evaluate/evaluate) using various metrics
