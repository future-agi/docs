...
# Initialize with your API credentials and dataset config for already created dataset
dataset_config = DatasetConfig(
    name="my_dataset",
    model_type=ModelTypes.GENERATIVE_LLM
)

dataset_object = DatasetClient(
...
dataset_object = DatasetClient.create_dataset(dataset_config=dataset_config)

# Download dataset
dataset_object.download_dataset(file_path="output.csv")

#Delete dataset
dataset_object.delete_dataset()
```
...
dataset_object = DatasetClient.create_dataset(
    dataset_config=dataset_config,
...
### Delete dataset using name

```python
# Delete a dataset
dataset = DatasetClient.delete_dataset(dataset_name="my_dataset")
```
