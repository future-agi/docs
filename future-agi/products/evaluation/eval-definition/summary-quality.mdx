...
### Differentiating Summary Quality with [Summarization Accuracy](https://docs.futureagi.com/future-agi/products/evaluation/eval-definition/summarization-accuracy)
