---
title: "How to Evaluate via CI/CD Pipeline"
---
...
Structure your evaluation data with the templates and inputs you want to test, for more details on how to set up evaluations refer to the [evals documentation](/future-agi/products/evaluation/quickstart).
