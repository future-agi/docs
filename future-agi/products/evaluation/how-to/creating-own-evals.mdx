...
While Future AGI offers comprehensive evaluation templates, custom evaluations are essential when you need to:
...
- **Model Selection**: Choose the appropriate model for your evaluation complexity:
  - **Future AGI Agents**: Proprietary models optimized for evaluations
    - **TURING_LARGE**: For complex evaluations requiring deep analysis
    - **TURING_SMALL**: For simple evaluations with faster processing
    - **PROTECT**: Safety and content moderation focused
    - **PROTECT_FLASH**: Lightweight safety evaluations
    - **TURING_FLASH**: Ultra-fast simple evaluations
  - **Other LLMs**: Use external language models from providers like OpenAI, Anthropic, etc.
...
eval_result = evaluator.evaluate(eval_templates = "your_eval_template_name", # Name of the evaluation template to use
                                ...
                                flash_protect = True, # Enable flash protection
)
