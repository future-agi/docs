...
description: "Future AGI allows you to use your own custom models for evaluation. This is useful if you want to use a model that is tailor made for your use case."
---
...
Once added, models are available platform-wide for evaluations and prompt testing.
