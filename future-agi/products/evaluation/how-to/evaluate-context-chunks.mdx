...
1. **Chunk Attribution** – Determines whether the model **acknowledges and references** the provided context.
2. **Chunk Utilization** – Measures **how effectively** the model integrates context into its response.
