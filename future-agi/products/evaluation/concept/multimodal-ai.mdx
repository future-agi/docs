...
title: Multimodal AI
---
`[example image of multimodal ai]`
...
`[architecture of common multimodal AI, such as florence2]`
...
4. **Output Generation** 
    ...
    <a href="/future-agi/products/evaluation/how-to/evaluate-images" style={{ color: "rgb(207, 107, 232)", textDecoration: "none", fontStyle: "italic" }}>Click here to learn how to evaluate your image-based multimodal system</a>
