...
---
`[diagram for agent as a judge example]`
...
<a href="/future-agi/products/evaluation/how-to/evaluate-agent-judge" style={{ color: "rgb(207, 107, 232)", textDecoration: "none", fontStyle: "italic" }}>Click here to learn how to evaluate using agent as a judge</a>
