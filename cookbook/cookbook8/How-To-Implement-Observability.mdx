---
title: Step by Step Guide on How to Setup FutureAGI Observe
...
![FutureAGI Dashboard](image.png)<figcaption>Dashboard from FutureAGI platform showcasing our deployed application in OBSERVE.</figcaption>
...
![FutureAGI Trace](image2.png)<figcaption> Trace Tree that shows the detailed overview of application session</figcaption>
...
- [Python Observability Best Practices](https://python.org/observability)
