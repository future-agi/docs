...
-   `protect_flash` (bool, optional): Enable flash protection. Defaults to False.
...
Evaluates if a conversation flows logically and maintains context throughout.```python
