...
[PreviousPrompt Template](/product-guides/examples/prompt-template)[NextRetrieval Augmented Generation (RAG)](/product-guides/examples/retrieval-augmented-generation-rag)
